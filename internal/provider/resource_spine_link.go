...
type SpineLinkResourceModel struct {
	...
	Timeouts    *SpineLinkTimeoutsModel `tfsdk:"timeouts"`
}

// SpineLinkTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_spine_link resource.
type SpineLinkTimeoutsModel struct {
