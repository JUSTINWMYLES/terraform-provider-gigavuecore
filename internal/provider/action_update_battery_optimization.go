...
type UpdateBatteryOptimizationActionModel struct {
	...
	CpuHibernation types.Dynamic `tfsdk:"cpu_hibernation" json:"cpuHibernation"`
	MonitorPort    types.Dynamic `tfsdk:"monitor_port" json:"monitorPort"`
	UnusedPort     types.Dynamic `tfsdk:"unused_port" json:"unusedPort"`
}
...
func (r *UpdateBatteryOptimizationAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "update battery optimization", Attributes: map[string]schema.Attribute{"cluster_id": schema.StringAttribute{MarkdownDescription: "Target Cluster ID", Required: true}, "cpu_hibernation": schema.DynamicAttribute{Optional: true}, "monitor_port": schema.DynamicAttribute{MarkdownDescription: "Monitor port off battery optimization", Optional: true}, "unused_port": schema.DynamicAttribute{MarkdownDescription: "Unused port off battery optimization", Optional: true}}}
}
