...
type InlineSslProfileResourceModel struct {
	...
	Timeouts                *InlineSslProfileTimeoutsModel `tfsdk:"timeouts"`
}

// InlineSslProfileTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_inline_ssl_profile resource.
type InlineSslProfileTimeoutsModel struct {
