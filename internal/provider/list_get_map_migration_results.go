...
func (l *GetMapMigrationResultsListResource) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{MarkdownDescription: "Query map migration results with filters"}
}

// List streams matching resource instances for terraform query.
func (l *GetMapMigrationResultsListResource) List(_ context.Context, _ list.ListRequest, stream *list.ListResultsStream) {
