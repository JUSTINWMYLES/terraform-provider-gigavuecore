...
type DiameterWhitelistResourceModel struct {
	...
	DiameterWhitelists types.List   `tfsdk:"diameter_whitelists" json:"diameterWhitelists"`
...
func (r *DiameterWhitelistResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Load available Diameter Whitelists", Attributes: map[string]schema.Attribute{"alias": schema.StringAttribute{Required: true}, "context": schema.SingleNestedAttribute{MarkdownDescription: "Gigamon query result context", Computed: true, Attributes: map[string]schema.Attribute{"page_no": schema.Int64Attribute{MarkdownDescription: "page number of the returned result set", Computed: true}, "page_size": schema.Int64Attribute{MarkdownDescription: "page size of the returned result set", Computed: true}, "sort": schema.ListAttribute{MarkdownDescription: "sorting info of the returned result set. list of fields in the array indicate sorting order", Computed: true, ElementType: types.StringType}, "total_items": schema.Int64Attribute{MarkdownDescription: "total number of items in the queried entity type", Computed: true}}}, "diameter_whitelists": schema.ListNestedAttribute{Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"alias": schema.StringAttribute{Computed: true}, "user_name_count": schema.Int64Attribute{MarkdownDescription: "Number of username entries in diameter-whitelist", Computed: true}}}}, "id": schema.StringAttribute{Computed: true}, "user_name_count": schema.Int64Attribute{MarkdownDescription: "Number of username entries in diameter-whitelist", Optional: true}}}
}
