...
var (
	...
	_ resource.ResourceWithImportState = (*PcapProfileResource)(nil)
...
func (r *PcapProfileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
