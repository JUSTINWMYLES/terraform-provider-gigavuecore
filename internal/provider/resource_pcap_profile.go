...
type PcapProfileResourceModel struct {
	...
	Timeouts      *PcapProfileTimeoutsModel `tfsdk:"timeouts"`
}

// PcapProfileTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_pcap_profile resource.
type PcapProfileTimeoutsModel struct {
