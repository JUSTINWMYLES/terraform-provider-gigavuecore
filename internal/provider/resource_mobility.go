...
type MobilityResourceModel struct {
	...
	Timeouts           *MobilityTimeoutsModel `tfsdk:"timeouts"`
}

// MobilityTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_mobility resource.
type MobilityTimeoutsModel struct {
