...
func (r *UpdateDeployAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Update unified resource deployment by environment and unified resource id", Attributes: map[string]schema.Attribute{"body": schema.SingleNestedAttribute{MarkdownDescription: "Unified Resource deployment", Required: true, Attributes: map[string]schema.Attribute{"name": schema.StringAttribute{Required: true}, "platform_type": schema.StringAttribute{Required: true}}}, "env_id": schema.StringAttribute{MarkdownDescription: "unified environment identifier", Required: true}, "unify_id": schema.StringAttribute{MarkdownDescription: "unified resource identifier", Required: true}}}
}
