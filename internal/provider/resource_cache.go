...
var (
	...
	_ resource.ResourceWithIdentity    = (*CacheResource)(nil)
...
type CacheResourceModel struct {
	...
	Timeouts            *CacheTimeoutsModel `tfsdk:"timeouts"`
}

// CacheTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_cache resource.
type CacheTimeoutsModel struct {
