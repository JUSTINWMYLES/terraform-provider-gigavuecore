...
func (r *UpdateInlineSslConfigAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Update inline SSL global configuration", Attributes: map[string]schema.Attribute{"body_cluster_id": schema.StringAttribute{MarkdownDescription: "id of the defining cluster", Optional: true}, "caching": schema.SingleNestedAttribute{Optional: true, Attributes: map[string]schema.Attribute{"persistence": schema.SingleNestedAttribute{Optional: true, Attributes: map[string]schema.Attribute{"enable": schema.BoolAttribute{Optional: true}}}}}, "cluster_id": schema.StringAttribute{MarkdownDescription: "Target Cluster ID", Required: true}, "dhe_ciphersuit": schema.StringAttribute{Optional: true}, "monitor": schema.SingleNestedAttribute{MarkdownDescription: "This property is moved to ssl profile for device version >=5.7", Optional: true, Attributes: map[string]schema.Attribute{"enable": schema.BoolAttribute{Optional: true}}}, "resumption": schema.SingleNestedAttribute{Optional: true, Attributes: map[string]schema.Attribute{"client": schema.SingleNestedAttribute{MarkdownDescription: "enable client initiated resumption (for debug purposes only)", Optional: true, Attributes: map[string]schema.Attribute{"enable": schema.BoolAttribute{Optional: true}}}}}, "ssl_versions": schema.SingleNestedAttribute{Optional: true, Attributes: map[string]schema.Attribute{"connection_reset_action_for_max_version": schema.StringAttribute{MarkdownDescription: "Action to take to reset connection if TLS version is higher than configured", Optional: true}, "connection_reset_action_for_min_version": schema.StringAttribute{MarkdownDescription: "Action to take to reset connection if TLS version is lower than configured", Optional: true}, "max_version": schema.StringAttribute{MarkdownDescription: "maxVersion must be greater than minVersion", Required: true}, "min_version": schema.StringAttribute{Required: true}}}, "start_tls": schema.SingleNestedAttribute{Optional: true, Attributes: map[string]schema.Attribute{"enable": schema.BoolAttribute{Optional: true}}}}}
}
