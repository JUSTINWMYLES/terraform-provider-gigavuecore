...
type FmNtpServerResourceModel struct {
	...
	Timeouts        *FmNtpServerTimeoutsModel `tfsdk:"timeouts"`
}

// FmNtpServerTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_fm_ntp_server resource.
type FmNtpServerTimeoutsModel struct {
...
func (r *FmNtpServerResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Add NTP Servers in FM", Attributes: map[string]schema.Attribute{"auth_required": schema.BoolAttribute{MarkdownDescription: "authentication enabled status", Required: true, PlanModifiers: []planmodifier.Bool{boolplanmodifier.RequiresReplace()}}, "fm_ip": schema.StringAttribute{MarkdownDescription: "FM HighAvailability Node address/host", Optional: true, Computed: true, PlanModifiers: []planmodifier.String{stringplanmodifier.RequiresReplace()}}, "is_user_ntp_server": schema.BoolAttribute{MarkdownDescription: "To differentiate user created ntp server and default ntp server", Optional: true, Computed: true, PlanModifiers: []planmodifier.Bool{boolplanmodifier.RequiresReplace()}}, "ntp_auth": schema.SingleNestedAttribute{MarkdownDescription: "NTP Auth Details", Optional: true, Computed: true, Attributes: map[string]schema.Attribute{"key": schema.StringAttribute{MarkdownDescription: "key for the ntp server", Required: true, PlanModifiers: []planmodifier.String{stringplanmodifier.RequiresReplace()}}, "type": schema.StringAttribute{MarkdownDescription: "Type of algorithm used for ntp server authentication", Required: true, PlanModifiers: []planmodifier.String{stringplanmodifier.RequiresReplace()}}, "value": schema.StringAttribute{MarkdownDescription: "value for the ntp server authentication", Required: true, PlanModifiers: []planmodifier.String{stringplanmodifier.RequiresReplace()}}}, PlanModifiers: []planmodifier.Object{objectplanmodifier.RequiresReplace()}}, "server_host": schema.StringAttribute{MarkdownDescription: "Ip/Host Address", Required: true, Validators: []validator.String{stringvalidator.LengthAtLeast(1)}, PlanModifiers: []planmodifier.String{stringplanmodifier.RequiresReplace()}}, "server_status": schema.SingleNestedAttribute{MarkdownDescription: "Server Status", Optional: true, Computed: true, Attributes: map[string]schema.Attribute{"offset": schema.Int64Attribute{Optional: true, Computed: true, PlanModifiers: []planmodifier.Int64{int64planmodifier.RequiresReplace()}}, "poll_interval": schema.StringAttribute{Optional: true, Computed: true, PlanModifiers: []planmodifier.String{stringplanmodifier.RequiresReplace()}}, "status": schema.StringAttribute{MarkdownDescription: "status of the server", Required: true, PlanModifiers: []planmodifier.String{stringplanmodifier.RequiresReplace()}}, "stratum": schema.StringAttribute{MarkdownDescription: "status of the server", Optional: true, Computed: true, PlanModifiers: []planmodifier.String{stringplanmodifier.RequiresReplace()}}}, PlanModifiers: []planmodifier.Object{objectplanmodifier.RequiresReplace()}}, "version": schema.Int64Attribute{MarkdownDescription: "version of server", Optional: true, Computed: true, PlanModifiers: []planmodifier.Int64{int64planmodifier.RequiresReplace()}}}, Blocks: map[string]schema.Block{"timeouts": schema.SingleNestedBlock{Attributes: map[string]schema.Attribute{"create": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the create operation. Defaults to 1200.", Optional: true}, "read": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the read operation. Defaults to 1200.", Optional: true}, "update": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the update operation. Defaults to 1200.", Optional: true}, "delete": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the delete operation. Defaults to 1200.", Optional: true}}, MarkdownDescription: "Per-operation timeouts in seconds."}}}
}
