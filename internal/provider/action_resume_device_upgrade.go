...
type ResumeDeviceUpgradeActionModel struct {
	DeviceUpgradeResumeSpecs types.List `tfsdk:"device_upgrade_resume_specs" json:"deviceUpgradeResumeSpecs"`
}
...
func (r *ResumeDeviceUpgradeAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Resume Device Upgrade", Attributes: map[string]schema.Attribute{"device_upgrade_resume_specs": schema.ListNestedAttribute{Required: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"activate_stage": schema.BoolAttribute{MarkdownDescription: "Activate Stage", Required: true}, "cluster_name": schema.StringAttribute{MarkdownDescription: "Cluster Name", Required: true}, "config_backup": schema.BoolAttribute{MarkdownDescription: "Config Backup", Required: true}, "device_ip": schema.StringAttribute{MarkdownDescription: "Device IP", Required: true}, "fetch_stage": schema.BoolAttribute{MarkdownDescription: "Fetch Stage", Required: true}, "install_stage": schema.BoolAttribute{MarkdownDescription: "Install Stage", Required: true}, "post_check_stage": schema.BoolAttribute{MarkdownDescription: "Post Check Stage", Required: true}, "task_id": schema.StringAttribute{MarkdownDescription: "Task ID", Required: true}}}}}}
}
