...
var (
	...
	_ resource.ResourceWithIdentity    = (*GtaProfileResource)(nil)
...
type GtaProfileResourceModel struct {
	...
	Timeouts         *GtaProfileTimeoutsModel `tfsdk:"timeouts"`
}

// GtaProfileTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_gta_profile resource.
type GtaProfileTimeoutsModel struct {
