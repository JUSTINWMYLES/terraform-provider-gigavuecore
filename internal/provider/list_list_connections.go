...
func (l *ListConnectionsListResource) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{MarkdownDescription: "List all unified resource connections by environment id", Attributes: map[string]listschema.Attribute{"env_id": listschema.StringAttribute{MarkdownDescription: "unified environment identifier", Required: true}}}
}
