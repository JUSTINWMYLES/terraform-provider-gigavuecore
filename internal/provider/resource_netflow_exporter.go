...
type NetflowExporterResourceModel struct {
	...
	Timeouts        *NetflowExporterTimeoutsModel `tfsdk:"timeouts"`
}

// NetflowExporterTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_netflow_exporter resource.
type NetflowExporterTimeoutsModel struct {
