...
func (r *ConnectionResource) Schema(ctx context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Get unified resource connection by environment id", Attributes: map[string]schema.Attribute{"unified_resources_connection_get_query_response": schema.DynamicAttribute{MarkdownDescription: "Unified Resource connection", Computed: true}}, Blocks: map[string]schema.Block{"timeouts": timeouts.Block(ctx, timeouts.Opts{Create: true, Read: true, Update: true, Delete: true})}}
}
