...
var (
	...
	_ resource.ResourceWithIdentity    = (*RedundancyProfileResource)(nil)
...
type RedundancyProfileResourceModel struct {
	...
	Timeouts       *RedundancyProfileTimeoutsModel `tfsdk:"timeouts"`
}

// RedundancyProfileTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_redundancy_profile resource.
type RedundancyProfileTimeoutsModel struct {
