...
var (
	...
	_ resource.ResourceWithIdentity    = (*ToolGroupResource)(nil)
...
type ToolGroupResourceModel struct {
	...
	Timeouts               *ToolGroupTimeoutsModel `tfsdk:"timeouts"`
}

// ToolGroupTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_tool_group resource.
type ToolGroupTimeoutsModel struct {
