...
type ConfigResourceModel struct {
	...
	Timeouts     *ConfigTimeoutsModel `tfsdk:"timeouts"`
}

// ConfigTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_config resource.
type ConfigTimeoutsModel struct {
...
func (r *ConfigResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Upload bulk replicate config file", Attributes: map[string]schema.Attribute{"cluster_ids": schema.ListAttribute{MarkdownDescription: "Cluster Ids the config file needs to be applied", Optional: true, ElementType: types.StringType}, "comment": schema.StringAttribute{MarkdownDescription: "User comments for the config file", Computed: true}, "created_ts": schema.Int64Attribute{MarkdownDescription: "File creation timestamp in UTC milliseconds", Computed: true}, "created_ts_utc": schema.StringAttribute{MarkdownDescription: "File creation timestamp in ISO 8601 format", Computed: true}, "family": schema.StringAttribute{MarkdownDescription: "['H' or 'G']: identifies whether this is an H-series or a G-series Config file", Computed: true}, "filename": schema.StringAttribute{MarkdownDescription: "Bulk Replicate config file name", Required: true, Validators: []validator.String{stringvalidator.LengthAtLeast(1)}}}, Blocks: map[string]schema.Block{"timeouts": schema.SingleNestedBlock{Attributes: map[string]schema.Attribute{"create": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the create operation. Defaults to 1200.", Optional: true}, "read": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the read operation. Defaults to 1200.", Optional: true}, "update": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the update operation. Defaults to 1200.", Optional: true}, "delete": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the delete operation. Defaults to 1200.", Optional: true}}, MarkdownDescription: "Per-operation timeouts in seconds."}}}
}
...
func (r *ConfigResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
	resp.IdentitySchema = identityschema.Schema{Attributes: map[string]identityschema.Attribute{"filename": identityschema.StringAttribute{RequiredForImport: true, Description: "Bulk Replicate config file name"}}}
}
...
func (r *ConfigResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	resp.Diagnostics.Append(resp.Identity.SetAttribute(ctx, path.Root("filename"), plan.Filename)...)
...
func (r *ConfigResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	resp.Diagnostics.Append(resp.Identity.SetAttribute(ctx, path.Root("filename"), state.Filename)...)
