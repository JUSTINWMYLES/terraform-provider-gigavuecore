...
func (r *ConfigResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Find bulk replicate config file by file name", Attributes: map[string]schema.Attribute{"comment": schema.StringAttribute{MarkdownDescription: "User comments for the config file", Computed: true}, "created_ts": schema.Int64Attribute{MarkdownDescription: "File creation timestamp in UTC milliseconds", Computed: true}, "created_ts_utc": schema.StringAttribute{MarkdownDescription: "File creation timestamp in ISO 8601 format", Computed: true}, "family": schema.StringAttribute{MarkdownDescription: "['H' or 'G']: identifies whether this is an H-series or a G-series Config file", Computed: true}, "filename": schema.StringAttribute{MarkdownDescription: "Bulk Replicate config file name", Required: true}}}
}
