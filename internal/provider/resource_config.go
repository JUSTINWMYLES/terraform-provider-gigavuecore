...
func (r *ConfigResource) Schema(ctx context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Upload bulk replicate config file", Attributes: map[string]schema.Attribute{"cluster_ids": schema.ListAttribute{MarkdownDescription: "Cluster Ids the config file needs to be applied", Optional: true, ElementType: types.StringType}, "comment": schema.StringAttribute{MarkdownDescription: "User comments for the config file", Computed: true}, "created_ts": schema.Int64Attribute{MarkdownDescription: "File creation timestamp in UTC milliseconds", Computed: true}, "created_ts_utc": schema.StringAttribute{MarkdownDescription: "File creation timestamp in ISO 8601 format", Computed: true}, "family": schema.StringAttribute{MarkdownDescription: "['H' or 'G']: identifies whether this is an H-series or a G-series Config file", Computed: true}, "filename": schema.StringAttribute{MarkdownDescription: "Bulk Replicate config file name", Required: true, Validators: []validator.String{stringvalidator.LengthAtLeast(1)}}}, Blocks: map[string]schema.Block{"timeouts": timeouts.Block(ctx, timeouts.Opts{Create: true, Read: true, Update: true, Delete: true})}}
}
