...
func (r *DownloadEventArchiveAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Archive Events", Attributes: map[string]schema.Attribute{"destination": schema.DynamicAttribute{Required: true}, "purge": schema.BoolAttribute{MarkdownDescription: "If true, the archived event entries will be purged", Optional: true}, "scope": schema.DynamicAttribute{Required: true}}}
}
