...
func (r *SourceRuleResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Get source rules for a policy and sourceRulesAlias", Attributes: map[string]schema.Attribute{"drop_rules": schema.DynamicAttribute{Optional: true, Computed: true}, "id": schema.StringAttribute{Computed: true}, "pass_rules": schema.DynamicAttribute{Optional: true, Computed: true}, "rule_ids": schema.StringAttribute{MarkdownDescription: "Rule IDs to match", Required: true}}}
}
