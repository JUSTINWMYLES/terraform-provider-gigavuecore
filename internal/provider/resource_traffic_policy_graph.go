...
var (
	...
	_ resource.ResourceWithIdentity    = (*TrafficPolicyGraphResource)(nil)
...
type TrafficPolicyGraphResourceModel struct {
	...
	Timeouts                  *TrafficPolicyGraphTimeoutsModel `tfsdk:"timeouts"`
}

// TrafficPolicyGraphTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_traffic_policy_graph resource.
type TrafficPolicyGraphTimeoutsModel struct {
