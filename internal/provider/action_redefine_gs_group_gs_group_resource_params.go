...
type RedefineGsGroupGsGroupResourceParamsActionModel struct {
	...
	Cpu             types.Dynamic `tfsdk:"cpu"`
	HsmSsl          types.Dynamic `tfsdk:"hsm_ssl" json:"hsmSsl"`
	InlineSsl       types.Dynamic `tfsdk:"inline_ssl" json:"inlineSsl"`
	Metadata        types.Int64   `tfsdk:"metadata"`
	PacketBuffer    types.Dynamic `tfsdk:"packet_buffer" json:"packetBuffer"`
	SessionOverload types.Dynamic `tfsdk:"session_overload" json:"sessionOverload"`
	TunnelOverload  types.Dynamic `tfsdk:"tunnel_overload" json:"tunnelOverload"`
