...
var (
	...
	_ resource.ResourceWithIdentity    = (*MetadataExporterResource)(nil)
	_ resource.ResourceWithImportState = (*MetadataExporterResource)(nil)
...
type MetadataExporterResourceModel struct {
	...
	Timeouts            *MetadataExporterTimeoutsModel `tfsdk:"timeouts"`
}

// MetadataExporterTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_metadata_exporter resource.
type MetadataExporterTimeoutsModel struct {
...
func (r *MetadataExporterResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
