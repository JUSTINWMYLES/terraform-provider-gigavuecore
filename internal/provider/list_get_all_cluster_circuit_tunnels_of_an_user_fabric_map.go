...
func (l *GetAllClusterCircuitTunnelsOfAnUserFabricMapListResource) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{MarkdownDescription: "Get all cluster circuit tunnel endpoints of a user-defined fabric map"}
}

// List streams matching resource instances for terraform query.
func (l *GetAllClusterCircuitTunnelsOfAnUserFabricMapListResource) List(_ context.Context, _ list.ListRequest, stream *list.ListResultsStream) {
