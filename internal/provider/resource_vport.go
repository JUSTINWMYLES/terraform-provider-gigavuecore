...
type VportResourceModel struct {
	...
	Timeouts           *VportTimeoutsModel `tfsdk:"timeouts"`
}

// VportTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_vport resource.
type VportTimeoutsModel struct {
