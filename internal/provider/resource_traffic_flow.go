...
type TrafficFlowResourceModel struct {
	...
	Timeouts           *TrafficFlowTimeoutsModel `tfsdk:"timeouts"`
}

// TrafficFlowTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_traffic_flow resource.
type TrafficFlowTimeoutsModel struct {
