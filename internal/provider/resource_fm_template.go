...
type FmTemplateResourceModel struct {
	...
	Timeouts         *FmTemplateTimeoutsModel `tfsdk:"timeouts"`
}

// FmTemplateTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_fm_template resource.
type FmTemplateTimeoutsModel struct {
