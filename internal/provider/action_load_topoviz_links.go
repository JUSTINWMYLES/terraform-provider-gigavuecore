...
type LoadTopovizLinksActionModel struct {
	DestinationHierarchicalTagsFilter types.Dynamic `tfsdk:"destination_hierarchical_tags_filter" json:"destinationHierarchicalTagsFilter"`
	DestinationPlacementTagFilter     types.Dynamic `tfsdk:"destination_placement_tag_filter" json:"destinationPlacementTagFilter"`
	DestinationSubGroupFilter         types.Dynamic `tfsdk:"destination_sub_group_filter" json:"destinationSubGroupFilter"`
	...
	LinksFilter                       types.Dynamic `tfsdk:"links_filter" json:"linksFilter"`
	SourceHierarchicalTagsFilter      types.Dynamic `tfsdk:"source_hierarchical_tags_filter" json:"sourceHierarchicalTagsFilter"`
	SourcePlacementTagFilter          types.Dynamic `tfsdk:"source_placement_tag_filter" json:"sourcePlacementTagFilter"`
	SourceSubGroupFilter              types.Dynamic `tfsdk:"source_sub_group_filter" json:"sourceSubGroupFilter"`
}
...
func (r *LoadTopovizLinksAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "load links from given nodes or nodeGroups", Attributes: map[string]schema.Attribute{"destination_hierarchical_tags_filter": schema.DynamicAttribute{MarkdownDescription: "List of tag key and tag values which specifies the hierarchy of destination node group", Optional: true}, "destination_placement_tag_filter": schema.DynamicAttribute{MarkdownDescription: "Tag key and tag values which specifies the placement of destination node group in sankey view", Optional: true}, "destination_sub_group_filter": schema.DynamicAttribute{MarkdownDescription: "Property name and value based on which the nodes are subGrouped", Optional: true}, "endpoint1_global_node_id": schema.StringAttribute{Optional: true}, "endpoint2_global_node_id": schema.StringAttribute{Optional: true}, "links_filter": schema.DynamicAttribute{MarkdownDescription: "Property name and values based on which the link are to be filtered", Optional: true}, "source_hierarchical_tags_filter": schema.DynamicAttribute{MarkdownDescription: "List of tag key and tag values which specifies the hierarchy of source node group", Optional: true}, "source_placement_tag_filter": schema.DynamicAttribute{MarkdownDescription: "Tag key and tag values which specifies the placement of source node group in sankey view", Optional: true}, "source_sub_group_filter": schema.DynamicAttribute{MarkdownDescription: "Property name and value based on which the nodes are subGrouped", Optional: true}}}
}
