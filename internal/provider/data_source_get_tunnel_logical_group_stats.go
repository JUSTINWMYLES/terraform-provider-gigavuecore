...
type GetTunnelLogicalGroupStatsDataSourceModel struct {
	...
	OctetsRx                   types.Int64  `tfsdk:"octets_rx" json:"octetsRx"`
	OctetsTx                   types.Int64  `tfsdk:"octets_tx" json:"octetsTx"`
	PacketsRx                  types.Int64  `tfsdk:"packets_rx" json:"packetsRx"`
	PacketsTx                  types.Int64  `tfsdk:"packets_tx" json:"packetsTx"`
	ProcessedTrafficPercentage types.Int64  `tfsdk:"processed_traffic_percentage" json:"processedTrafficPercentage"`
}
...
func (d *GetTunnelLogicalGroupStatsDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Get Stats for Tunnel Logical Groups", Attributes: map[string]schema.Attribute{"alias": schema.StringAttribute{MarkdownDescription: "Tunnel Logical Group Alias", Required: true}, "deviation": schema.Int64Attribute{MarkdownDescription: "Traffic Deviation in Percentage", Computed: true}, "last_successful_attempt_time": schema.StringAttribute{MarkdownDescription: "Last Stats Polled Timestamp UTC Format", Computed: true}, "octets_rx": schema.Int64Attribute{MarkdownDescription: "Decapsulation end Octets Tx", Computed: true}, "octets_tx": schema.Int64Attribute{MarkdownDescription: "Encapsulation end Octets Tx", Computed: true}, "packets_rx": schema.Int64Attribute{MarkdownDescription: "Decapsulation end Packets Tx", Computed: true}, "packets_tx": schema.Int64Attribute{MarkdownDescription: "Encapsulation end Packets Tx", Computed: true}, "processed_traffic_percentage": schema.Int64Attribute{MarkdownDescription: "Amount of Traffic Processed based on Encap Packets Tx and Decap Packets Rx", Computed: true}}}
}
