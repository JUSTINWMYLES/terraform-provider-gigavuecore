...
func (l *LoadIpDestinationStatusesListResource) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{MarkdownDescription: "Load IP destination status of all or those matching the IP Interface alias or IP type or GsGroup"}
}

// List streams matching resource instances for terraform query.
func (l *LoadIpDestinationStatusesListResource) List(_ context.Context, _ list.ListRequest, stream *list.ListResultsStream) {
