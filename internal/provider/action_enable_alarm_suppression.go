...
func (r *EnableAlarmSuppressionAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Enable alarm suppression rules for multiple resources", Attributes: map[string]schema.Attribute{"suppressed_entities": schema.DynamicAttribute{MarkdownDescription: "Suppression Rules for resource", Required: true}}}
}
