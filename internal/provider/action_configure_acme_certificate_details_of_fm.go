...
func (r *ConfigureAcmeCertificateDetailsOfFmAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "renew/revoke ACME certificate of FM", Attributes: map[string]schema.Attribute{"acme_certificate": schema.ListNestedAttribute{Optional: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"domain": schema.StringAttribute{MarkdownDescription: "domain name can be FM IP or FQDN", Required: true}}}}, "operation_type": schema.StringAttribute{MarkdownDescription: "operationType of the acme certificate renew/revoke", Required: true}}}
}
