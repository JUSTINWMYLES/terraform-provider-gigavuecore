...
type PortConfigResourceModel struct {
	...
	Timeouts          *PortConfigTimeoutsModel `tfsdk:"timeouts"`
}

// PortConfigTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_port_config resource.
type PortConfigTimeoutsModel struct {
