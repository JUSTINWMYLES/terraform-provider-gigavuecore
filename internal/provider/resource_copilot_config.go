...
type CopilotConfigResourceModel struct {
	...
	Timeouts         *CopilotConfigTimeoutsModel `tfsdk:"timeouts"`
}

// CopilotConfigTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_copilot_config resource.
type CopilotConfigTimeoutsModel struct {
