...
type HbProfileResourceModel struct {
	...
	Timeouts             *HbProfileTimeoutsModel `tfsdk:"timeouts"`
}

// HbProfileTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_hb_profile resource.
type HbProfileTimeoutsModel struct {
