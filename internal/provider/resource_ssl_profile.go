...
type SslProfileResourceModel struct {
	...
	Timeouts  *SslProfileTimeoutsModel `tfsdk:"timeouts"`
}

// SslProfileTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_ssl_profile resource.
type SslProfileTimeoutsModel struct {
