...
func (r *FileResource) Schema(ctx context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Search inline SSL profile nodecryptlist or decryptlist for a domain", Attributes: map[string]schema.Attribute{"cluster_id": schema.StringAttribute{MarkdownDescription: "Target Cluster ID", Required: true}, "file": schema.StringAttribute{MarkdownDescription: "file to upload to device", Required: true}, "id": schema.StringAttribute{Computed: true}, "result": schema.StringAttribute{MarkdownDescription: "(deprecated: use resultAlias instead)", Computed: true}, "result_alias": schema.StringAttribute{Computed: true}}, Blocks: map[string]schema.Block{"timeouts": timeouts.Block(ctx, timeouts.Opts{Create: true, Read: true, Update: true, Delete: true})}}
}
