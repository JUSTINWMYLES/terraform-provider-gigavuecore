...
type LoadAliasesMetaDataActionModel struct {
	Specs types.Dynamic `tfsdk:"specs"`
}
...
func (r *LoadAliasesMetaDataAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Get meta data details for given list of resources", Attributes: map[string]schema.Attribute{"specs": schema.DynamicAttribute{Required: true}}}
}
