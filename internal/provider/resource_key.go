...
type KeyResourceModel struct {
	...
	Timeouts           *KeyTimeoutsModel `tfsdk:"timeouts"`
}

// KeyTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_key resource.
type KeyTimeoutsModel struct {
