...
type GsopResourceModel struct {
	...
	Timeouts           *GsopTimeoutsModel `tfsdk:"timeouts"`
}

// GsopTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_gsop resource.
type GsopTimeoutsModel struct {
