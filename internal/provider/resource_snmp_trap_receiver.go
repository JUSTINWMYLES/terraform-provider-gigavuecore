...
type SnmpTrapReceiverResourceModel struct {
	...
	Timeouts      *SnmpTrapReceiverTimeoutsModel `tfsdk:"timeouts"`
}

// SnmpTrapReceiverTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_snmp_trap_receiver resource.
type SnmpTrapReceiverTimeoutsModel struct {
