...
type CircuitTunnelResourceModel struct {
	...
	Timeouts   *CircuitTunnelTimeoutsModel `tfsdk:"timeouts"`
}

// CircuitTunnelTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_circuit_tunnel resource.
type CircuitTunnelTimeoutsModel struct {
