...
func (l *DownloadListListResource) ListResourceConfigSchema(_ context.Context, _ list.ListResourceSchemaRequest, resp *list.ListResourceSchemaResponse) {
	resp.Schema = listschema.Schema{MarkdownDescription: "Download a nodecryptlist or decryptlist", Attributes: map[string]listschema.Attribute{"alias": listschema.StringAttribute{MarkdownDescription: "Alias of the inline SSL profile", Required: true}, "cluster_id": listschema.StringAttribute{MarkdownDescription: "Target Cluster ID", Required: true}, "list_type": listschema.StringAttribute{MarkdownDescription: "specify a nodecryptlist or decryptlist. (deprecated: use nodecryptlist and decryptlist instead of whitelist and blacklist)", Required: true}}}
}
