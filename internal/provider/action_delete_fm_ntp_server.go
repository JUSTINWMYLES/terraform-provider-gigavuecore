...
type DeleteFmNtpServerActionModel struct {
	...
	NtpAuth         types.Dynamic `tfsdk:"ntp_auth" json:"ntpAuth"`
	ServerHost      types.String  `tfsdk:"server_host" json:"serverHost"`
	ServerStatus    types.Dynamic `tfsdk:"server_status" json:"serverStatus"`
