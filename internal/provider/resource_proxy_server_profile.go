...
var (
	...
	_ resource.ResourceWithImportState = (*ProxyServerProfileResource)(nil)
...
type ProxyServerProfileResourceModel struct {
	...
	Timeouts                 *ProxyServerProfileTimeoutsModel `tfsdk:"timeouts"`
}

// ProxyServerProfileTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_proxy_server_profile resource.
type ProxyServerProfileTimeoutsModel struct {
...
func (r *ProxyServerProfileResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
