...
type ToolResourceModel struct {
	...
	Timeouts                *ToolTimeoutsModel `tfsdk:"timeouts"`
}

// ToolTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_tool resource.
type ToolTimeoutsModel struct {
...
func (r *ToolResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Create a new Inline Tool", Attributes: map[string]schema.Attribute{"alias": schema.StringAttribute{MarkdownDescription: "Inline Tool alias. Unique within a cluster", Required: true}, "cluster_id": schema.StringAttribute{MarkdownDescription: "Target Cluster ID", Required: true}, "combined_heart_beat_status": schema.StringAttribute{MarkdownDescription: "combined Heartbeat status", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("up", "down")}}, "comment": schema.StringAttribute{Optional: true, Computed: true}, "enabled": schema.BoolAttribute{Optional: true, Computed: true}, "failover_action": schema.StringAttribute{Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("toolBypass", "toolDrop", "networkBypass", "networkDrop", "networkPortForcedDown")}}, "flex_status": schema.StringAttribute{Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("forwarding", "forcedBypassing", "failoverBypassing", "forcedDropping", "failoverDropping", "monitoring", "networkFailover", "undefined")}}, "flex_traffic_path": schema.StringAttribute{Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("drop", "bypass", "monitoring", "toInlineTool")}}, "health_state": schema.StringAttribute{MarkdownDescription: "Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("green", "yellow", "orange", "red")}}, "health_state_reasons": schema.ListNestedAttribute{Optional: true, Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"message": schema.StringAttribute{MarkdownDescription: "Read-only. Describes the reason for component's health state", Optional: true, Computed: true}, "severity": schema.StringAttribute{MarkdownDescription: "Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("green", "yellow", "orange", "red")}}, "traffic_health_state_computation_type": schema.StringAttribute{MarkdownDescription: "Traffic Health State Computation Type", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("PORT_LOW_UTIL", "PORT_HIGH_UTIL", "PORT_PACKET_DROP", "PORT_PACKET_ERROR", "GIGASTREAM_IMBALANCE")}}}}}, "heartbeat": schema.SingleNestedAttribute{MarkdownDescription: "Embedded Heartbeat configuration for an Inline Tool. Private class", Optional: true, Computed: true, Attributes: map[string]schema.Attribute{"enabled": schema.BoolAttribute{Required: true}, "ip_address_a": schema.StringAttribute{MarkdownDescription: "the destination IP address to be used in heartbeat packets send from side A to side B (the default is N.N.N.N where N is the port number within the chassis as shown on the face plate)", Required: true}, "ip_address_b": schema.StringAttribute{MarkdownDescription: "the destination IP address to be used in heartbeat packets send from side B to side A (the default is N.N.N.N where N is the port number within the chassis as shown on the face plate)", Required: true}, "profile": schema.StringAttribute{MarkdownDescription: "Alias of referenced Heartbeat Profile. the default is the heartbeat profile named 'default'", Required: true}, "status": schema.SingleNestedAttribute{MarkdownDescription: "Embedded Heartbeat configuration for an Inline Tool. Private class", Optional: true, Computed: true, Attributes: map[string]schema.Attribute{"heartbeat_passing": schema.StringAttribute{MarkdownDescription: "indicates whether heartbeat packets from portA are reaching portB and vice versa", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("up", "down", "unknown")}}, "stats_ato_b": schema.SingleNestedAttribute{MarkdownDescription: "Embedded Heartbeat configuration for an Inline Tool. Private class", Required: true, Attributes: map[string]schema.Attribute{"rx_count": schema.Int64Attribute{MarkdownDescription: "number of heartbeat packets received", Required: true, Validators: []validator.Int64{int64validator.AtLeast(0)}}, "tx_count": schema.Int64Attribute{MarkdownDescription: "number of heartbeat packets sent", Required: true, Validators: []validator.Int64{int64validator.AtLeast(0)}}}}, "stats_bto_a": schema.SingleNestedAttribute{MarkdownDescription: "Embedded Heartbeat configuration for an Inline Tool. Private class", Required: true, Attributes: map[string]schema.Attribute{"rx_count": schema.Int64Attribute{MarkdownDescription: "number of heartbeat packets received", Required: true, Validators: []validator.Int64{int64validator.AtLeast(0)}}, "tx_count": schema.Int64Attribute{MarkdownDescription: "number of heartbeat packets sent", Required: true, Validators: []validator.Int64{int64validator.AtLeast(0)}}}}}}}}, "inline_tool_type": schema.StringAttribute{MarkdownDescription: "inlineTool type", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("external", "gmon")}}, "negative_heartbeat": schema.SingleNestedAttribute{MarkdownDescription: "Embedded Heartbeat configuration for an Inline Tool. Private class", Optional: true, Computed: true, Attributes: map[string]schema.Attribute{"enabled": schema.BoolAttribute{Required: true}, "profile": schema.StringAttribute{MarkdownDescription: "Alias of referenced Negative Heartbeat Profile", Optional: true, Computed: true}, "status": schema.SingleNestedAttribute{MarkdownDescription: "Embedded Heartbeat configuration for an Inline Tool. Private class", Optional: true, Computed: true, Attributes: map[string]schema.Attribute{"heartbeat_passing": schema.StringAttribute{MarkdownDescription: "indicates whether heartbeat packets from portA are reaching portB and vice versa", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("up", "down", "unknown")}}, "stats_ato_b": schema.SingleNestedAttribute{MarkdownDescription: "Embedded Heartbeat configuration for an Inline Tool. Private class", Required: true, Attributes: map[string]schema.Attribute{"rx_count": schema.Int64Attribute{MarkdownDescription: "number of heartbeat packets received", Required: true, Validators: []validator.Int64{int64validator.AtLeast(0)}}, "tx_count": schema.Int64Attribute{MarkdownDescription: "number of heartbeat packets sent", Required: true, Validators: []validator.Int64{int64validator.AtLeast(0)}}}}, "stats_bto_a": schema.SingleNestedAttribute{MarkdownDescription: "Embedded Heartbeat configuration for an Inline Tool. Private class", Required: true, Attributes: map[string]schema.Attribute{"rx_count": schema.Int64Attribute{MarkdownDescription: "number of heartbeat packets received", Required: true, Validators: []validator.Int64{int64validator.AtLeast(0)}}, "tx_count": schema.Int64Attribute{MarkdownDescription: "number of heartbeat packets sent", Required: true, Validators: []validator.Int64{int64validator.AtLeast(0)}}}}}}}}, "operational_state": schema.StringAttribute{MarkdownDescription: "Operational State", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("disable", "up", "down", "ready")}}, "port_a": schema.StringAttribute{MarkdownDescription: "portId of side A inline tool port", Required: true, Validators: []validator.String{stringvalidator.LengthAtLeast(1)}}, "port_a_status": schema.StringAttribute{MarkdownDescription: "port A status", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("up", "down")}}, "port_b": schema.StringAttribute{MarkdownDescription: "portId of side B inline tool port", Required: true, Validators: []validator.String{stringvalidator.LengthAtLeast(1)}}, "port_b_status": schema.StringAttribute{MarkdownDescription: "port B status", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("up", "down")}}, "recovery_mode": schema.StringAttribute{Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("manual", "automatic")}}, "shared": schema.BoolAttribute{MarkdownDescription: "inline tool sharing mode", Optional: true, Computed: true}, "timestamp": schema.StringAttribute{MarkdownDescription: "date-time of stats collection in RFC 3339 format", Optional: true, Computed: true}}, Blocks: map[string]schema.Block{"timeouts": schema.SingleNestedBlock{Attributes: map[string]schema.Attribute{"create": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the create operation. Defaults to 1200.", Optional: true}, "read": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the read operation. Defaults to 1200.", Optional: true}, "update": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the update operation. Defaults to 1200.", Optional: true}, "delete": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the delete operation. Defaults to 1200.", Optional: true}}, MarkdownDescription: "Per-operation timeouts in seconds."}}}
}
...
func (r *ToolResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
	resp.IdentitySchema = identityschema.Schema{Attributes: map[string]identityschema.Attribute{"alias": identityschema.StringAttribute{RequiredForImport: true, Description: "Inline Tool alias. Unique within a cluster"}}}
}
...
func (r *ToolResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	toolImportIDParts := strings.Split(req.ID, "/")
	if len(toolImportIDParts) != 2 {
	...
	resp.Diagnostics.Append(resp.State.SetAttribute(ctx, path.Root("alias"), toolImportIDParts[0])...)
	resp.Diagnostics.Append(resp.State.SetAttribute(ctx, path.Root("cluster_id"), toolImportIDParts[1])...)
}
