...
type NetworkProfileResourceModel struct {
	...
	Timeouts      *NetworkProfileTimeoutsModel `tfsdk:"timeouts"`
}

// NetworkProfileTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_network_profile resource.
type NetworkProfileTimeoutsModel struct {
...
func (r *NetworkProfileResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
