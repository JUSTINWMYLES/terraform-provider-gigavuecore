...
type GigastreamResourceModel struct {
	...
	Timeouts           *GigastreamTimeoutsModel `tfsdk:"timeouts"`
}

// GigastreamTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_gigastream resource.
type GigastreamTimeoutsModel struct {
