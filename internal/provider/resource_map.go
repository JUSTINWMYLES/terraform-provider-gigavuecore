...
var (
	...
	_ resource.ResourceWithIdentity    = (*MapResource)(nil)
...
type MapResourceModel struct {
	...
	Timeouts                    *MapTimeoutsModel `tfsdk:"timeouts"`
}

// MapTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_map resource.
type MapTimeoutsModel struct {
