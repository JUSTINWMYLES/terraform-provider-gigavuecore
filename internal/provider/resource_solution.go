...
type SolutionResourceModel struct {
	...
	Timeouts                       *SolutionTimeoutsModel `tfsdk:"timeouts"`
}

// SolutionTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_solution resource.
type SolutionTimeoutsModel struct {
