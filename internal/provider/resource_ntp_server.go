...
type NtpServerResourceModel struct {
	...
	Timeouts   *NtpServerTimeoutsModel `tfsdk:"timeouts"`
}

// NtpServerTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_ntp_server resource.
type NtpServerTimeoutsModel struct {
