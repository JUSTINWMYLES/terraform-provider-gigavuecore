...
type NetworkGroupResourceModel struct {
	...
	Timeouts           *NetworkGroupTimeoutsModel `tfsdk:"timeouts"`
}

// NetworkGroupTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_network_group resource.
type NetworkGroupTimeoutsModel struct {
