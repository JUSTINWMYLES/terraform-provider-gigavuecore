...
type DeletePcapFileActionModel struct {
	...
	PcapDeleteList types.Dynamic `tfsdk:"pcap_delete_list" json:"pcapDeleteList"`
}
...
func (r *DeletePcapFileAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Delete Pcap File", Attributes: map[string]schema.Attribute{"cluster_id": schema.StringAttribute{MarkdownDescription: "Target Cluster ID", Required: true}, "pcap_delete_list": schema.DynamicAttribute{Optional: true}}}
}
