...
var (
	...
	_ resource.ResourceWithIdentity    = (*HsmResource)(nil)
...
type HsmResourceModel struct {
	...
	Timeouts          *HsmTimeoutsModel `tfsdk:"timeouts"`
}

// HsmTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_hsm resource.
type HsmTimeoutsModel struct {
