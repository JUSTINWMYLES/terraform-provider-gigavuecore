...
type ProfileResourceModel struct {
	...
	Timeouts          *ProfileTimeoutsModel `tfsdk:"timeouts"`
}

// ProfileTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_profile resource.
type ProfileTimeoutsModel struct {
