...
func (r *ArchiveServerResource) Schema(ctx context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Find FM Backup Archive Server by alias", Attributes: map[string]schema.Attribute{"address": schema.StringAttribute{Required: true, Validators: []validator.String{stringvalidator.LengthAtLeast(1)}}, "alias": schema.StringAttribute{MarkdownDescription: "archive server unique alias", Required: true, Validators: []validator.String{stringvalidator.LengthAtLeast(1)}}, "remote_base_path": schema.StringAttribute{MarkdownDescription: "remote file staging location where FM copies/lists the archived file(s)", Required: true, Validators: []validator.String{stringvalidator.LengthAtLeast(1)}}, "type": schema.StringAttribute{Required: true, Validators: []validator.String{stringvalidator.OneOf("scp", "sftp")}}, "user_name": schema.StringAttribute{MarkdownDescription: "username to use for server login.", Required: true, Validators: []validator.String{stringvalidator.LengthAtLeast(1)}}, "user_pwd": schema.StringAttribute{MarkdownDescription: "user password to use for server login.", Optional: true, Computed: true}}, Blocks: map[string]schema.Block{"timeouts": timeouts.Block(ctx, timeouts.Opts{Create: true, Read: true, Update: true, Delete: true})}}
}
