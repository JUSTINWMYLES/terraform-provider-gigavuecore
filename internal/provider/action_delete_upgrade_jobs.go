...
func (r *DeleteUpgradeJobsAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Delete Upgrade Jobs", Attributes: map[string]schema.Attribute{"task_ids": schema.StringAttribute{MarkdownDescription: "Task IDs", Required: true}}}
}
