...
type IntentPolicyResourceModel struct {
	...
	Timeouts           *IntentPolicyTimeoutsModel `tfsdk:"timeouts"`
}

// IntentPolicyTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_intent_policy resource.
type IntentPolicyTimeoutsModel struct {
