...
type RadiusServerResourceModel struct {
	...
	Timeouts      *RadiusServerTimeoutsModel `tfsdk:"timeouts"`
}

// RadiusServerTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_radius_server resource.
type RadiusServerTimeoutsModel struct {
