...
type RecordResourceModel struct {
	...
	Timeouts       *RecordTimeoutsModel `tfsdk:"timeouts"`
}

// RecordTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_record resource.
type RecordTimeoutsModel struct {
