...
type AppVisibilityResourceModel struct {
	...
	Timeouts                  *AppVisibilityTimeoutsModel `tfsdk:"timeouts"`
}

// AppVisibilityTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_app_visibility resource.
type AppVisibilityTimeoutsModel struct {
