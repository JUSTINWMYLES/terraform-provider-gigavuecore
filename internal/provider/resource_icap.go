...
type IcapResourceModel struct {
	...
	Timeouts            *IcapTimeoutsModel `tfsdk:"timeouts"`
}

// IcapTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_icap resource.
type IcapTimeoutsModel struct {
