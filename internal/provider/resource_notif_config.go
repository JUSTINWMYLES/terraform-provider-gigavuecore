...
type NotifConfigResourceModel struct {
	...
	Timeouts      *NotifConfigTimeoutsModel `tfsdk:"timeouts"`
}

// NotifConfigTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_notif_config resource.
type NotifConfigTimeoutsModel struct {
