...
var (
	_ resource.Resource                = (*NotifConfigResource)(nil)
	_ resource.ResourceWithImportState = (*NotifConfigResource)(nil)
)
...
func (r *NotifConfigResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	resp.Diagnostics.Append(resp.State.SetAttribute(ctx, path.Root("interface_type"), req.ID)...)
}
