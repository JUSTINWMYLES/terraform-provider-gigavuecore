...
type TestGigaInsightNodeConnectionActionModel struct {
	BedrockConfig types.Dynamic `tfsdk:"bedrock_config" json:"bedrockConfig"`
	GoogleConfig  types.Dynamic `tfsdk:"google_config" json:"googleConfig"`
	NodeId        types.String  `tfsdk:"node_id"`
	OpenAiConfig  types.Dynamic `tfsdk:"open_ai_config" json:"openAIConfig"`
	PrivateConfig types.Dynamic `tfsdk:"private_config" json:"privateConfig"`
...
func (r *TestGigaInsightNodeConnectionAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Test LLM provider connection via a GigaInsight Node", Attributes: map[string]schema.Attribute{"bedrock_config": schema.DynamicAttribute{MarkdownDescription: "AWS Bedrock provider configuration", Optional: true}, "google_config": schema.DynamicAttribute{MarkdownDescription: "Google Vertex AI provider configuration", Optional: true}, "node_id": schema.StringAttribute{Required: true}, "open_ai_config": schema.DynamicAttribute{MarkdownDescription: "OpenAI provider configuration", Optional: true}, "private_config": schema.DynamicAttribute{MarkdownDescription: "Private (Azure AI Foundry) provider configuration", Optional: true}, "provider_": schema.StringAttribute{MarkdownDescription: "The LLM provider type", Required: true}, "proxy_url": schema.StringAttribute{MarkdownDescription: "Optional proxy URL for the connection", Optional: true}}}
}
