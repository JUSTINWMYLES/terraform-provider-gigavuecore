...
var (
	...
	_ resource.ResourceWithIdentity    = (*AlertPolicyResource)(nil)
...
type AlertPolicyResourceModel struct {
	...
	Timeouts       *AlertPolicyTimeoutsModel `tfsdk:"timeouts"`
}

// AlertPolicyTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_alert_policy resource.
type AlertPolicyTimeoutsModel struct {
...
func (r *AlertPolicyResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Creation of alert policy", Attributes: map[string]schema.Attribute{"clear_condition": schema.SingleNestedAttribute{MarkdownDescription: "Alert clear condition definition", Required: true, Attributes: map[string]schema.Attribute{"interval": schema.SingleNestedAttribute{MarkdownDescription: "Alert clear interval config", Required: true, Attributes: map[string]schema.Attribute{"duration": schema.Int64Attribute{MarkdownDescription: "Averaging time duration", Required: true}, "unit": schema.StringAttribute{MarkdownDescription: "Unit of duration", Required: true, Validators: []validator.String{stringvalidator.OneOf("MINUTES", "HOURS")}}}}, "threshold": schema.SingleNestedAttribute{MarkdownDescription: "Alert clear threshold definition", Optional: true, Computed: true, Attributes: map[string]schema.Attribute{"severity": schema.StringAttribute{MarkdownDescription: "Severity of the alert", Required: true, Validators: []validator.String{stringvalidator.OneOf("Info", "Minor", "Warn", "Major", "Critical")}}, "threshold": schema.Float64Attribute{MarkdownDescription: "Threshold percentage value", Required: true}}}, "type": schema.StringAttribute{MarkdownDescription: "Alert clear type", Required: true, Validators: []validator.String{stringvalidator.OneOf("TIME_BASED", "THRESHOLD_BASED")}}}}, "condition": schema.SingleNestedAttribute{MarkdownDescription: "Alert condition definition", Required: true, Attributes: map[string]schema.Attribute{"interval": schema.SingleNestedAttribute{MarkdownDescription: "Alert interval config", Required: true, Attributes: map[string]schema.Attribute{"duration": schema.Int64Attribute{MarkdownDescription: "Averaging time duration", Required: true}, "unit": schema.StringAttribute{MarkdownDescription: "Unit of duration", Required: true, Validators: []validator.String{stringvalidator.OneOf("MINUTES", "HOURS")}}}}, "thresholds": schema.ListNestedAttribute{MarkdownDescription: "Alert threshold definitions", Required: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"severity": schema.StringAttribute{MarkdownDescription: "Severity of the alert", Required: true, Validators: []validator.String{stringvalidator.OneOf("Info", "Minor", "Warn", "Major", "Critical")}}, "threshold": schema.Float64Attribute{MarkdownDescription: "Threshold percentage value", Required: true}}}}}}, "description": schema.StringAttribute{MarkdownDescription: "Description of the alert policy", Optional: true, Computed: true}, "enabled": schema.BoolAttribute{MarkdownDescription: "Status of the alert policy", Optional: true, Computed: true}, "metric": schema.StringAttribute{MarkdownDescription: "Metric name for which the alert policy is created", Required: true, Validators: []validator.String{stringvalidator.OneOf("TUNNEL_TRAFFIC_MONITORING")}}, "policy_name": schema.StringAttribute{MarkdownDescription: "Name of the alert policy, like an alias", Required: true}, "resource_type": schema.StringAttribute{MarkdownDescription: "Type of the resource, only tunnelMonitoring is supported in 6.1", Optional: true, Computed: true, Validators: []validator.String{stringvalidator.OneOf("tunnelMonitoring")}}, "resources": schema.DynamicAttribute{MarkdownDescription: "Resources associated to alert policy. Based on source type, the resources structure varies", Required: true}}, Blocks: map[string]schema.Block{"timeouts": schema.SingleNestedBlock{Attributes: map[string]schema.Attribute{"create": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the create operation. Defaults to 1200.", Optional: true}, "read": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the read operation. Defaults to 1200.", Optional: true}, "update": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the update operation. Defaults to 1200.", Optional: true}, "delete": schema.Int64Attribute{MarkdownDescription: "Maximum time in seconds for the delete operation. Defaults to 1200.", Optional: true}}, MarkdownDescription: "Per-operation timeouts in seconds."}}}
}
...
func (r *AlertPolicyResource) IdentitySchema(_ context.Context, _ resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
	resp.IdentitySchema = identityschema.Schema{Attributes: map[string]identityschema.Attribute{"policy_name": identityschema.StringAttribute{RequiredForImport: true, Description: "Name of the alert policy, like an alias"}}}
}
...
func (r *AlertPolicyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	resp.Diagnostics.Append(resp.Identity.SetAttribute(ctx, path.Root("policy_name"), plan.PolicyName)...)
...
func (r *AlertPolicyResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	resp.Diagnostics.Append(resp.Identity.SetAttribute(ctx, path.Root("policy_name"), state.PolicyName)...)
