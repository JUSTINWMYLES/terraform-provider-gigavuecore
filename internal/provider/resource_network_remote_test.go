...
func TestNetworkResource_Create_Happy(t *testing.T) {
	r := &NetworkResource{client: newMockClientStatus(t, 201, "{\"alias\":\"example-id\"}")}
...
func TestNetworkResource_Create_APIError(t *testing.T) {
	r := &NetworkResource{client: newMockClientStatus(t, 501, "{\"message\":\"boom\"}")}
	m := NetworkResourceModel{}
	resp := &resource.CreateResponse{}
	r.createRemote(context.Background(), &m, resp)
	hasErrorContaining(t, resp.Diagnostics, "Error creating gigavuecore_network")
}
...
func TestNetworkResource_Create_APIErrorReadBody(t *testing.T) {
	r := &NetworkResource{client: newMockClientReadErrorBody(t, 501)}
	m := NetworkResourceModel{}
	resp := &resource.CreateResponse{}
	r.createRemote(context.Background(), &m, resp)
...
func TestNetworkResource_Create_MapError(t *testing.T) {
	r := &NetworkResource{client: newMockClientStatus(t, 201, "{\"alias\":12345}")}
	m := NetworkResourceModel{}
	resp := &resource.CreateResponse{}
	r.createRemote(context.Background(), &m, resp)
...
func TestNetworkResource_Read_APIError(t *testing.T) {
	...
	resp := &resource.ReadResponse{}
	r.readRemote(context.Background(), &m, resp)
	hasErrorContaining(t, resp.Diagnostics, "Error reading gigavuecore_network")
}
...
func TestNetworkResource_Read_MapError(t *testing.T) {
	r := &NetworkResource{client: newMockClientStatus(t, 200, "{\"alias\":12345}")}
	m := NetworkResourceModel{}
	resp := &resource.ReadResponse{}
	r.readRemote(context.Background(), &m, resp)
	hasErrorContaining(t, resp.Diagnostics, "Could not map response to state")
...
func TestNetworkResource_Update_APIError(t *testing.T) {
	...
	resp := &resource.UpdateResponse{}
	r.updateRemote(context.Background(), &m, resp)
	hasErrorContaining(t, resp.Diagnostics, "Error updating gigavuecore_network")
}
...
func TestNetworkResource_Delete_Happy(t *testing.T) {
	r := &NetworkResource{client: newMockClientStatus(t, 204, "")}
	m := NetworkResourceModel{}
...
func TestNetworkResource_Delete_APIError(t *testing.T) {
	...
	resp := &resource.DeleteResponse{}
	r.deleteRemote(context.Background(), &m, resp)
	hasErrorContaining(t, resp.Diagnostics, "Error deleting gigavuecore_network")
}
