...
type FlexInlineResourceModel struct {
	...
	Timeouts            *FlexInlineTimeoutsModel `tfsdk:"timeouts"`
}

// FlexInlineTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_flex_inline resource.
type FlexInlineTimeoutsModel struct {
