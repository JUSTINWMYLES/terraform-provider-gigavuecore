...
func (r *UserResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Load User by Username", Attributes: map[string]schema.Attribute{"context": schema.SingleNestedAttribute{MarkdownDescription: "Gigamon query result context", Computed: true, Attributes: map[string]schema.Attribute{"page_no": schema.Int64Attribute{MarkdownDescription: "page number of the returned result set", Computed: true}, "page_size": schema.Int64Attribute{MarkdownDescription: "page size of the returned result set", Computed: true}, "sort": schema.ListAttribute{MarkdownDescription: "sorting info of the returned result set. list of fields in the array indicate sorting order", Computed: true, ElementType: types.StringType}, "total_items": schema.Int64Attribute{MarkdownDescription: "total number of items in the queried entity type", Computed: true}}}, "email_id": schema.StringAttribute{MarkdownDescription: "email ID", Required: true}, "enabled": schema.BoolAttribute{Optional: true}, "full_name": schema.StringAttribute{MarkdownDescription: "user's full name", Optional: true}, "groups": schema.ListAttribute{Optional: true, ElementType: types.StringType}, "id": schema.StringAttribute{Computed: true}, "password": schema.StringAttribute{MarkdownDescription: "password", Required: true, Sensitive: true}, "username": schema.StringAttribute{MarkdownDescription: "username", Required: true}, "users": schema.ListNestedAttribute{Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"email_id": schema.StringAttribute{MarkdownDescription: "email ID", Computed: true}, "enabled": schema.BoolAttribute{Computed: true}, "full_name": schema.StringAttribute{MarkdownDescription: "user's full name", Computed: true}, "groups": schema.ListAttribute{Computed: true, ElementType: types.StringType}, "password": schema.StringAttribute{MarkdownDescription: "password", Computed: true, Sensitive: true}, "username": schema.StringAttribute{MarkdownDescription: "username", Computed: true}}}}}}
}
