...
func (d *GetUpgradeExecutionTimelineDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "get Upgrade Execution Timeline By ClusterId", Attributes: map[string]schema.Attribute{"cluster_id": schema.StringAttribute{Required: true}, "items": schema.DynamicAttribute{Computed: true}}}
}
