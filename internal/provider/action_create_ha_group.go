...
type CreateHaGroupActionModel struct {
	FmHaTunnel types.Dynamic `tfsdk:"fm_ha_tunnel" json:"fmHaTunnel"`
...
func (r *CreateHaGroupAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "create HA group", Attributes: map[string]schema.Attribute{"fm_ha_tunnel": schema.DynamicAttribute{Required: true}, "name": schema.StringAttribute{MarkdownDescription: "Name of the new FMHA cluster", Required: true}, "nodes": schema.DynamicAttribute{Required: true}}}
}
