...
type UpdateTopologyVizConfigsActionModel struct {
	AliasConfig               types.Dynamic `tfsdk:"alias_config" json:"aliasConfig"`
	HierarchicalTags          types.List    `tfsdk:"hierarchical_tags" json:"hierarchicalTags"`
	LinkRepresentationConfigs types.Dynamic `tfsdk:"link_representation_configs" json:"linkRepresentationConfigs"`
	NetworkDevicesEnabled     types.Bool    `tfsdk:"network_devices_enabled" json:"networkDevicesEnabled"`
	PlacementTags             types.Dynamic `tfsdk:"placement_tags" json:"placementTags"`
