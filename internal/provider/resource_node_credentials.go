...
var (
	...
	_ resource.ResourceWithIdentity    = (*NodeCredentialsResource)(nil)
...
type NodeCredentialsResourceModel struct {
	...
	Timeouts      *NodeCredentialsTimeoutsModel `tfsdk:"timeouts"`
}

// NodeCredentialsTimeoutsModel describes the per-operation timeout configuration (in seconds) for the gigavuecore_node_credentials resource.
type NodeCredentialsTimeoutsModel struct {
...
func (r *NodeCredentialsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	resp.Diagnostics.Append(resp.Identity.SetAttribute(ctx, path.Root("device_address"), plan.DeviceAddress)...)
...
func (r *NodeCredentialsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	resp.Diagnostics.Append(resp.Identity.SetAttribute(ctx, path.Root("device_address"), state.DeviceAddress)...)
