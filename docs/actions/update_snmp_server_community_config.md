---
page_title: "gigavuecore_update_snmp_server_community_config Action - gigavuecore"
subcategory: ""
description: |-
  Update Snmp Server Community config
---

# gigavuecore_update_snmp_server_community_config Action
...
```terraform
action "gigavuecore_update_snmp_server_community_config" "example" {
  config {
    cluster_id               = "example"
