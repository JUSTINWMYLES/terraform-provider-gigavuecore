...
* `destination_hierarchical_tags_filter` (List(Dynamic), optional) - List of tag key and tag values which specifies the hierarchy of destination node group
...
* `source_hierarchical_tags_filter` (List(Dynamic), optional) - List of tag key and tag values which specifies the hierarchy of source node group
