...
* `clear_condition` (Attributes) (see [below for nested schema](#nestedatt--policies--clear_condition))
* `condition` (Attributes) (see [below for nested schema](#nestedatt--policies--condition))
...
* `interval` (Attributes) (see [below for nested schema](#nestedatt--policies--clear_condition--interval))
* `type` (String) - Alert clear type
Optional:

* `threshold` (Attributes) (see [below for nested schema](#nestedatt--policies--clear_condition--threshold))
...
* `interval` (Attributes) (see [below for nested schema](#nestedatt--policies--condition--interval))
