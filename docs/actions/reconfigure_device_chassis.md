---
page_title: "gigavuecore_reconfigure_device_chassis Action - gigavuecore"
subcategory: ""
description: |-
  Reconfigure device chassis. Can change the boxId as long as the chassis is not configured first.
---

# gigavuecore_reconfigure_device_chassis Action
...
* `gdp` (Bool, optional) - enable/disable GDP for chassis
* `l2_gre_id` (Number, optional) - for type l2gre maximum value is 4294967295 , Value of 0 disables the vxlanId
* `leaf_config` (Dynamic, optional) - Configuration of Leaf node for Spine-Link
