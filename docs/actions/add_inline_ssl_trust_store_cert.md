---
page_title: "gigavuecore_add_inline_ssl_trust_store_cert Action - gigavuecore"
subcategory: ""
description: |-
  Add certificate to the inline SSL trust-store
---

# gigavuecore_add_inline_ssl_trust_store_cert Action
...
```terraform
action "gigavuecore_add_inline_ssl_trust_store_cert" "example" {
  config {
    file = "example"
    file_source = {
      hostname = "example"
