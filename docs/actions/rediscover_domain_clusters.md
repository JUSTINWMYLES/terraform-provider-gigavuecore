...
* `async` (Bool, optional) - if provided, the call returns immediately with the \[201 Accepted\] HTTP status code, and the discovery process will complete in the background
