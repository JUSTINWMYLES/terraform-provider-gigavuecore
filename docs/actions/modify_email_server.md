...
* `enable_auto_support_notif` (Bool, optional) - Enable Auto Support Notifications
* `enable_smtp_auth` (Bool, optional) - Enable SMTP auth
* `include_hostname` (Bool, optional) - Include Hostname
