...
* `enabled` (Bool, optional) - Enable/Disable elephant flow detection and handling
* `interval` (Number, optional) - time interval in seconds
* `log_enabled` (Bool, optional) - Enable/Disable logging of elephant flow parameters into gs logs
