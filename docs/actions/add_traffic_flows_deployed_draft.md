---
page_title: "gigavuecore_add_traffic_flows_deployed_draft Action - gigavuecore"
subcategory: ""
description: |-
  Add a new deployed traffic flows draft
---

# gigavuecore_add_traffic_flows_deployed_draft Action
...
```terraform
action "gigavuecore_add_traffic_flows_deployed_draft" "example" {
  config {
    alias             = "example"
    comment           = "example"
...
* `sources_and_rules` (List of Dynamic, required)
