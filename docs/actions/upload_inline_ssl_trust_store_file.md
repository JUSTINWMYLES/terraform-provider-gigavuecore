---
page_title: "gigavuecore_upload_inline_ssl_trust_store_file Action - gigavuecore"
subcategory: ""
description: |-
  Upload inline SSL trust-store from local file
---

# gigavuecore_upload_inline_ssl_trust_store_file Action
...
```terraform
action "gigavuecore_upload_inline_ssl_trust_store_file" "example" {
  config {
    cluster_id = "example"
    file       = "example"
  }
