...
* `alias_config` (List of Dynamic, optional) - Node group titles can be set using this property. This is applicable only for smart sankey.
...
* `link_representation_configs` (List of Dynamic, optional)
...
* `placement_tags` (List of Dynamic, required)
