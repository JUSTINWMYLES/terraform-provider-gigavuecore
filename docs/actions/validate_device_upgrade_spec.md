---
page_title: "gigavuecore_validate_device_upgrade_spec Action - gigavuecore"
subcategory: ""
description: |-
  Validate Device Upgrade Spec
---

# gigavuecore_validate_device_upgrade_spec Action
...
```terraform
action "gigavuecore_validate_device_upgrade_spec" "example" {
  config {
    activate_stage       = true
    cluster_ids          = [ "example" ]
    config_backup        = true
    ...
    image_file_specs = [{
      ...
      device_model_qualifier = "example"
      file_path              = "example"
      file_type              = "example"
      target_slot            = "example"
