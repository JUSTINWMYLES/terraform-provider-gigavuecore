...
* `access_roles` (Attributes, computed) - Port Access RBAC definitions (see [below for nested schema](#nestedatt--access_roles))
* `alarm_thresholds` (Attributes, computed) - Port Alarm Thresholds definitions (see [below for nested schema](#nestedatt--alarm_thresholds))
* `fec` (String, computed) - enable/disable forward error correction
* `gdp` (Boolean, computed) - enable/disable GDP packets on port
...
* `licensed` (Boolean, computed) - for TA series indicates whether a port is licensed. Defaults to 'true'
* `lock` (Attributes, computed) - Port Locking definitions (see [below for nested schema](#nestedatt--lock))
* `mpls_advanced` (Attributes, computed) - Select a combination of Mpls-Advanced options (see [below for nested schema](#nestedatt--mpls_advanced))
* `neighbor_discovery` (String, computed) - Configures port neighbor discovery options
* `ptp` (Attributes, computed) - Port PTP configurations (see [below for nested schema](#nestedatt--ptp))
* `share` (Attributes, computed) - Port Sharing definitions (see [below for nested schema](#nestedatt--share))
...
* `timestamp` (Attributes, computed) - Timestamping definitions for GigaPORT-X12-TS ports (see [below for nested schema](#nestedatt--timestamp))
...
* `egress` (Attributes) (see [below for nested schema](#nestedatt--ptp--timestamp--egress))
* `ingress` (Attributes) (see [below for nested schema](#nestedatt--ptp--timestamp--ingress))
...
```shell
terraform import gigavuecore_port_config.example {port_id}
```
