...
* `enabled` (Bool, optional) - Temporarily enable/disable logins for the specified account. Disabling an account closes any currently open sessions for the specified account
* `full_name` (String, optional) - Full name for the account (referred to sometimes as the gecos)
* `roles` (List(String), optional) - References to the Roles defined for the User
...
* `enabled` (Bool, computed) - Temporarily enable/disable logins for the specified account. Disabling an account closes any currently open sessions for the specified account
* `full_name` (String, computed) - Full name for the account (referred to sometimes as the gecos)
* `roles` (List(String), computed) - References to the Roles defined for the User
