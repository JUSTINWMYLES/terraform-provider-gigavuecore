...
subcategory: ""
description: |-
  Create a new Application Intelligence Solution on V Series
---
...
* `app_export_config` (Attributes, optional) - Application Metadata Configuration (see [below for nested schema](#nestedatt--app_export_config))
* `app_filter_config` (Attributes, optional) - Application Filtering Configuration (see [below for nested schema](#nestedatt--app_filter_config))
...
* `monitor_solution_config` (Attributes, required) - Application Monitoring configuration (see [below for nested schema](#nestedatt--monitor_solution_config))
