...
* `afm_map` (Attributes, required) - Detailed definition of this fabric map (see [below for nested schema](#nestedatt--afm_map))
* `alias` (String, optional) - unique map alias
...
* `dst_ports` (List of String, optional) - List of the 'to' ports. Invalid if 'nullDstPort' is true'. Only port number is supported
...
* `src_ports` (List of String, optional) - list of the 'from' ports. Only port number is supported
...
* `updated_time` (Number, optional) - Fabric map updated timestamp in UTC
