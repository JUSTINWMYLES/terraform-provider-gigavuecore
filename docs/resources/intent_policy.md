...
* `tool_id` (String, optional) - Tool Id to filter by

### Attributes

In addition to all arguments above, the following computed attributes are exported:

* `policies` (Attributes List, computed) (see [below for nested schema](#nestedatt--policies))
...
* `apf` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--apf))
* `dedup` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--dedup))
* `diameter_whitelist` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--diameter_whitelist))
...
* `gseries_header_remove` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--gseries_header_remove))
...
* `gtp_whitelist` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--gtp_whitelist))
...
* `metadata_export` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--metadata_export))
* `netflow` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--netflow))
* `sa_apf` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--sa_apf))
* `sip_whitelist` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--sip_whitelist))
...
* `custom` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--tunnel_decap--custom))
...
* `tls_pcapng` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--tunnel_decap--tls_pcapng))
* `vxlan` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--tunnel_decap--vxlan))
...
* `tls_pcapng` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--gs_apps--tunnel_encap--tls_pcapng))
...
* `apf` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--apf))
* `dedup` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--dedup))
* `diameter_whitelist` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--diameter_whitelist))
...
* `gseries_header_remove` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--gseries_header_remove))
...
* `gtp_whitelist` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--gtp_whitelist))
...
* `metadata_export` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--metadata_export))
* `netflow` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--netflow))
* `sa_apf` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--sa_apf))
* `sip_whitelist` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--sip_whitelist))
...
* `custom` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--tunnel_decap--custom))
* `erspan_flow_id` (Number) - only applicable for 'erspan', A Flow ID of 0 decapsulates all ERSPAN tunnel traffic regardless of Flow ID
* `gmip_port` (Number) - only applicable for 'gmip', in which case it is required. Specifies the UDP port on which the Tunnel Network port on the receiving GigaVUE H Series is listening. Must match the configuration of the portdst configured on the sending end of the tunnel
* `l2_gre_key` (Number) - only applicable for 'l2gre', in which case it is required.
* `tls_pcapng` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--tunnel_decap--tls_pcapng))
* `vxlan` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--tunnel_decap--vxlan))
...
* `tls_pcapng` (Attributes) (see [below for nested schema](#nestedatt--rules--gs_operations--templates--gs_apps--tunnel_encap--tls_pcapng))
...
* `comment` (String)
* `deployed` (Boolean) - policy is deployed or not
* `deployment_error` (String) - policy deployment error message
* `deployment_percent` (String) - policy deployment percentage
* `dest_port_timestamp` (String)
* `health_state` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--policies--health_state_reasons))
* `name` (String) - policy name
* `policy_id` (String) - generated unique policy ID
* `policy_timestamp` (String)
* `priority` (Boolean)
* `rules` (Attributes List) (see [below for nested schema](#nestedatt--policies--rules))
* `src_port_timestamp` (String)
* `src_ports_info` (Attributes) (see [below for nested schema](#nestedatt--policies--src_ports_info))
* `tags` (Attributes List) (see [below for nested schema](#nestedatt--policies--tags))
<a id="nestedatt--policies--health_state_reasons"></a>
### Nested Schema for `policies.health_state_reasons`
...
* `comment` (String)
* `gs_operations` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations))
* `health_state` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--policies--rules--health_state_reasons))
* `high_priority_drop` (Boolean)
* `matches` (Attributes List) (see [below for nested schema](#nestedatt--policies--rules--matches))
* `no_expansion_tags` (List of String)
* `rule_id` (String)
* `rule_name` (String)
* `tools` (Attributes List) (see [below for nested schema](#nestedatt--policies--rules--tools))
* `type` (String)
<a id="nestedatt--policies--rules--gs_operations"></a>
### Nested Schema for `policies.rules.gs_operations`

Read-Only:

* `gs_apps` (Attributes) - GigaSMART Applications for a GSOP. At least one GsApp must be defined for the config to be valid (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps))
* `gs_engines` (List of String)
* `gs_group_params` (Attributes) - GsGroup Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params))
* `templates` (Attributes List) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates))
<a id="nestedatt--policies--rules--gs_operations--gs_apps"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps`

Read-Only:

* `apf` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--apf))
* `dedup` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--dedup))
* `diameter_whitelist` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--diameter_whitelist))
* `flow_filter` (Attributes) - GigaSMART 'Flow Filter' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--flow_filter))
* `flow_sampling` (Attributes) - GigaSMART 'Flow Sampling' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--flow_sampling))
* `gseries_header_add` (Attributes) - Only applicable for G-series (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--gseries_header_add))
* `gseries_header_remove` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--gseries_header_remove))
* `gseries_load_balance` (Attributes) - Only applicable for G-series per-rule GSOP (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--gseries_load_balance))
* `gseries_pattern_match` (Attributes) - Only applicable for G-series per-rule GSOP (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--gseries_pattern_match))
* `gtp_whitelist` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--gtp_whitelist))
* `header_add` (Attributes) - GigaSMART 'Add Header' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--header_add))
* `header_remove` (Attributes) - GigaSMART 'Remove Header' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--header_remove))
* `icap` (Attributes) - GigaSMART ICAP Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--icap))
* `inline_ssl` (Attributes) - GigaSMART Inline SSL Profile Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--inline_ssl))
* `load_balance` (Attributes) - GigaSMART 'Load Balancing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--load_balance))
* `masking` (Attributes) - GigaSMART 'Masking' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--masking))
* `metadata_export` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--metadata_export))
* `netflow` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--netflow))
* `sa_apf` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--sa_apf))
* `sip_whitelist` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--sip_whitelist))
* `slicing` (Attributes) - GigaSMART 'Slicing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--slicing))
* `ssl_decrypt` (Attributes) - GigaSMART 'SSL Decrypt' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--ssl_decrypt))
* `trailer_add` (Attributes) - GigaSMART 'Add Trailer' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--trailer_add))
* `trailer_remove` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--trailer_remove))
* `tunnel_decap` (Attributes) - GigaSMART 'Decapsulate Tunnel' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--tunnel_decap))
* `tunnel_encap` (Attributes) - GigaSMART 'Encapsulate Tunnel' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap))
<a id="nestedatt--policies--rules--gs_operations--gs_apps--apf"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.apf`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--dedup"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.dedup`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--diameter_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.diameter_whitelist`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--flow_filter"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.flow_filter`

Read-Only:

* `type` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--flow_sampling"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.flow_sampling`

Read-Only:

* `type` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--gseries_header_add"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.gseries_header_add`

Read-Only:

* `types` (Set of String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--gseries_header_remove"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.gseries_header_remove`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--gseries_load_balance"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.gseries_load_balance`

Read-Only:

* `fixed_offset` (Attributes) - Per-rule Fixed Offset Load Balancing config for G-seres devices (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--gseries_load_balance--fixed_offset))
* `variable_offset` (Attributes) - Per-rule Variable Offset Load Balancing config for G-seres devices (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--gseries_load_balance--variable_offset))
<a id="nestedatt--policies--rules--gs_operations--gs_apps--gseries_load_balance--fixed_offset"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.gseries_load_balance.fixed_offset`
...
* `length` (Number)
* `offset` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--gseries_load_balance--variable_offset"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.gseries_load_balance.variable_offset`
...
* `start_delim` (String)
* `start_field` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--gseries_pattern_match"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.gseries_pattern_match`

Read-Only:

* `fixed_offset` (Attributes) - Per-rule Fixed Offset Pattern Match config for G-seres devices (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--gseries_pattern_match--fixed_offset))
* `variable_offset` (Attributes) - Per-rule Variable Offset Pattern Match config for G-seres devices (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--gseries_pattern_match--variable_offset))
<a id="nestedatt--policies--rules--gs_operations--gs_apps--gseries_pattern_match--fixed_offset"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.gseries_pattern_match.fixed_offset`

Read-Only:

* `length` (Number)
* `offset` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--gseries_pattern_match--variable_offset"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.gseries_pattern_match.variable_offset`

Read-Only:

* `end_delim` (String)
* `start_delim` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--gtp_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.gtp_whitelist`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--header_add"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.header_add`

Read-Only:

* `vlan` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--header_remove"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.header_remove`
...
* `vlan_header` (String) - Only valid when protocol is 'vlan'. Specifies the target vlan header to strip. Defaults to 'outer'
* `vxlan_id` (Number) - 24-bit value. Only valid when protocol is 'vxlan'. Specifies the vxlan id to strip. Value of '0' will strip all vxlan ids
<a id="nestedatt--policies--rules--gs_operations--gs_apps--icap"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.icap`

Read-Only:

* `icap_profile` (String) - Alias of referenced ICAP Profile
<a id="nestedatt--policies--rules--gs_operations--gs_apps--inline_ssl"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.inline_ssl`

Read-Only:

* `inline_ssl_profile` (String) - Alias of referenced Inline SSL Profile
<a id="nestedatt--policies--rules--gs_operations--gs_apps--load_balance"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.load_balance`

Read-Only:

* `enhanced` (Attributes) - Private class. Enhanced part of the GigaSMART 'Load Balancing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--load_balance--enhanced))
* `stateful` (Attributes) - Private class. Stateful part of the GigaSMART 'Load Balancing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--load_balance--stateful))
* `stateless` (Attributes) - Private class. Stateless part of the GigaSMART 'Load Balancing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--load_balance--stateless))
<a id="nestedatt--policies--rules--gs_operations--gs_apps--load_balance--enhanced"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.load_balance.enhanced`

Read-Only:

* `elb_alias` (String) - elb app alias
<a id="nestedatt--policies--rules--gs_operations--gs_apps--load_balance--stateful"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.load_balance.stateful`

Read-Only:

* `app_type` (String) - 'sapf' option is added in release H 4.3.01. 'sip' and 'tunnel' added in release H 5.1. 'diameter' is added in release H 5.5
* `diameter_key_hash_type` (String) - required when 'appType' == 'diameter' and 'lbType' == 'diameterKeyHash'
* `diameter_key_multi_hash_type` (Attributes List) - required when 'appType' == 'diameter' and 'lbType' == 'diameterKeyMultiHash' (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--load_balance--stateful--diameter_key_multi_hash_type))
* `gtp_key_hash_type` (String) - required when 'appType' == 'gtp' and 'lbType' == 'gtpKeyHash'. ignored otherwise
* `lb_type` (String) - 'gtpKeyHash' is only applicable when 'appType' == 'gtp'. 'sipKeyHash' is only applicable when 'appType' == 'sip'
* `sip_key_hash_type` (String) - required when 'appType' == 'sip' and 'lbType' == 'sipKeyHash'. ignored otherwise
<a id="nestedatt--policies--rules--gs_operations--gs_apps--load_balance--stateful--diameter_key_multi_hash_type"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.load_balance.stateful.diameter_key_multi_hash_type`

Read-Only:

* `avp_codevalue` (Number) - required when 'key' == 'avpCode'
* `key` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--load_balance--stateless"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.load_balance.stateless`

Read-Only:

* `field_location` (String) - Ignored when 'hashFields' == 'gtpuTeid'. Required otherwise
* `hash_fields` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--masking"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.masking`
...
* `pattern` (String) - 1-byte hex mask, not applicable for protocol 'sip' valid and required otherwise
* `protocol` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--metadata_export"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.metadata_export`

Read-Only:

* `cache` (String) - metadata cache alias. cache should have exporters defined, and the exporters should have applicationProfiles defined
<a id="nestedatt--policies--rules--gs_operations--gs_apps--netflow"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.netflow`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--sa_apf"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.sa_apf`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--sip_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.sip_whitelist`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--slicing"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.slicing`
...
* `offset` (Number) - min offset is 64 for 'none'; 4 for protocol-referenced offsets. required property till H 5.6
* `protocol` (String) - required property till H 5.6
<a id="nestedatt--policies--rules--gs_operations--gs_apps--ssl_decrypt"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.ssl_decrypt`

Read-Only:

* `in_port` (Number) - Port number of 0 represents 'any' port
* `out_port` (Number) - Port number of 0 represents 'auto' port
<a id="nestedatt--policies--rules--gs_operations--gs_apps--trailer_add"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.trailer_add`

Read-Only:

* `types` (Set of String) - 'crc' is not applicable for G-series
<a id="nestedatt--policies--rules--gs_operations--gs_apps--trailer_remove"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.trailer_remove`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--tunnel_decap"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.tunnel_decap`

Read-Only:

* `custom` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--tunnel_decap--custom))
* `erspan_flow_id` (Number) - only applicable for 'erspan', A Flow ID of 0 decapsulates all ERSPAN tunnel traffic regardless of Flow ID
* `gmip_port` (Number) - only applicable for 'gmip', in which case it is required. Specifies the UDP port on which the Tunnel Network port on the receiving GigaVUE H Series is listening. Must match the configuration of the portdst configured on the sending end of the tunnel
* `l2_gre_key` (Number) - only applicable for 'l2gre', in which case it is required.
* `tls_pcapng` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--tunnel_decap--tls_pcapng))
* `type` (String)
* `vxlan` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--tunnel_decap--vxlan))
<a id="nestedatt--policies--rules--gs_operations--gs_apps--tunnel_decap--custom"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.tunnel_decap.custom`

Read-Only:

* `port_dst` (Number) - when specified as 0, no validation will be done in the packet.
* `port_src` (Number) - when specified as 0, no validation will be done in the packet.
<a id="nestedatt--policies--rules--gs_operations--gs_apps--tunnel_decap--tls_pcapng"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.tunnel_decap.tls_pcapng`

Read-Only:

* `decap_key` (String)
* `listener` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--tunnel_decap--vxlan"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.tunnel_decap.vxlan`
...
* `port_src` (Number) - when specified as 0, no validation will be done in the packet.
* `vni` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.tunnel_encap`

Read-Only:

* `gmip_config` (Attributes) - Configuration for GMIP Tunnel Encapsulate GigaSmaprt App (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap--gmip_config))
* `l2_gre_config` (Attributes) - Configuration for l2GRE Tunnel Encapsulate GigaSmaprt App (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap--l2_gre_config))
* `tls_pcapng` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap--tls_pcapng))
* `type` (String)
* `vxlan_config` (Attributes) - Configuration for Vxlan Tunnel Encapsulate GigaSmaprt App (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap--vxlan_config))
<a id="nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap--gmip_config"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.tunnel_encap.gmip_config`
...
* `src_port` (Number)
* `ttl` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap--l2_gre_config"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.tunnel_encap.l2_gre_config`
...
* `session_pos` (String) - required if 'sessionField' is specified
* `ttl` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap--tls_pcapng"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.tunnel_encap.tls_pcapng`

Read-Only:

* `exporter` (String)
* `exporter_group` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_apps--tunnel_encap--vxlan_config"></a>
### Nested Schema for `policies.rules.gs_operations.gs_apps.tunnel_encap.vxlan_config`
...
* `ttl` (Number)
* `vni` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params`

Read-Only:

* `app_tcp` (Attributes) - GsGroup TCP Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--app_tcp))
* `dedup` (Attributes) - GsGroup Dedup Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--dedup))
* `diameter_packet` (Attributes) - GsGroup Diameter Packet Timeout Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--diameter_packet))
* `diameter_s6_a_session` (Attributes) - GsGroup Diameter s6a Session Timeout Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--diameter_s6_a_session))
* `diameter_whitelist` (Attributes) - GsGroup Diameter Whitelist Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--diameter_whitelist))
* `eflow` (Attributes) - GsGroup Eflow Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--eflow))
* `engine_watchdog_timer` (Attributes) - GsGroup EngineWatchdogTimer Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--engine_watchdog_timer))
* `erspan3` (Attributes) - GsGroup ERSPAN III Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--erspan3))
* `flow_mask` (Attributes) - GsGroup Flow Mask Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--flow_mask))
* `flow_sampling` (Attributes) - GsGroup Flow Sampling Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--flow_sampling))
* `generic_session_timeout` (Attributes) - GsGroup Generic Session Timeout Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--generic_session_timeout))
* `gpfcp_profiles` (Attributes) - Enriched CUPS Gpfcp profile aliases (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--gpfcp_profiles))
* `gs_group_system` (Attributes) - GsGroup System Monitoring Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--gs_group_system))
* `gta_profiles` (Attributes) - 3GPP CUPS gta profile aliases (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--gta_profiles))
* `gtp_control_sampling` (Attributes) - GsGroup Gtp Control Sampling Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--gtp_control_sampling))
* `gtp_flow` (Attributes) - GsGroup Gtp Flow Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--gtp_flow))
* `gtp_gpfcp_delay` (Attributes) - GsGroup Gtp GPFCP Delay time (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--gtp_gpfcp_delay))
* `gtp_persistence` (Attributes) - GsGroup Gtp Persistence Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--gtp_persistence))
* `gtp_random_sampling` (Attributes) - GsGroup Gtp Random Sampling Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--gtp_random_sampling))
* `gtp_whitelist` (Attributes) - GsGroup GTP Whitelist Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--gtp_whitelist))
* `health_check` (Attributes) - health check configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--health_check))
* `hsm_group` (Attributes) - GsGroup Hsm Group Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--hsm_group))
* `ip_frag` (Attributes) - GsGroup IP Fragmentation Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--ip_frag))
* `load_balance` (Attributes) - GsGroup Load Balancing Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--load_balance))
* `netflow` (Attributes) - GsGroup Netflow Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--netflow))
* `node_role` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--node_role))
* `port_throttle_sip` (Attributes) - GsGroup SIP Port Throttle Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--port_throttle_sip))
* `resource` (Attributes) - GsGroup Resource Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--resource))
* `rtp_ports` (Attributes) - GsGroup Rtp Ports Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--rtp_ports))
* `sa_apf` (Attributes) - GsGroup Session Aware APF Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--sa_apf))
* `session_logging` (Attributes) - GsGroup Session Logging Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--session_logging))
* `sffp_profiles` (Attributes) - 3GPP CUPS sffp profile aliases (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--sffp_profiles))
* `sip_media` (Attributes) - GsGroup Sip Media Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--sip_media))
* `sip_ports` (Attributes) - GsGroup Sip Ports Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--sip_ports))
* `sip_session` (Attributes) - GsGroup Sip Session Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--sip_session))
* `sip_tcp_idle_timeout` (Attributes) - GsGroup Sip Tcp Idle Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--sip_tcp_idle_timeout))
* `sip_whitelist` (Attributes) - GsGroup SIP Whitelist Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--sip_whitelist))
* `ssl_decrypt` (Attributes) - GsGroup SSL Decrypt Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--ssl_decrypt))
* `xpkt_match` (Attributes) - cross packet match configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--xpkt_match))
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--app_tcp"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.app_tcp`
...
* `load_balance` (Boolean) - Enables TCP loadbalancing for the Tool Ports. Supports SIP & N11 only
* `tcp_control` (String) - To choose the action on TCP Control messages
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--dedup"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.dedup`
...
* `timer` (Number) - in microseconds
* `vlan` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--diameter_packet"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.diameter_packet`

Read-Only:

* `timeout` (Number) - timeout in seconds to remove OOO or fragmented packet
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--diameter_s6_a_session"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.diameter_s6_a_session`

Read-Only:

* `limit` (Number) - Number of sessions to allocate for Diameter S6A
* `timeout` (Number) - timeout in seconds used to clean inactive sessions
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--diameter_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.diameter_whitelist`

Read-Only:

* `whitelist` (String) - Alias of referenced diameter Whitelist
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--eflow"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.eflow`
...
* `packet_count` (Number) - Number of packets to be received by a flow
* `packet_ratio` (Number) - Percentage of packets in a flow vs overall packet count
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--engine_watchdog_timer"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.engine_watchdog_timer`

Read-Only:

* `time` (Number) - Engine Watchdog Timer value, time to restart in seconds .Valid values: 60-600. 0 is disable
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--erspan3"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.erspan3`

Read-Only:

* `timestamp_format` (String) - erspan III tunnelDecap timestamp format
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--flow_mask"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.flow_mask`
...
* `length` (Number)
* `offset` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--flow_sampling"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.flow_sampling`
...
* `timeout` (Number) - in minutes
* `type` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--generic_session_timeout"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.generic_session_timeout`

Read-Only:

* `time` (Number) - Maximum timeout for session entry
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--gpfcp_profiles"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.gpfcp_profiles`

Read-Only:

* `g_pfcp_profiles` (List of String)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--gs_group_system"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.gs_group_system`

Read-Only:

* `cpu_load_alarm_threshold` (Number) - CPU rising threshold percentage 20-99%. Once this threshold is crossed for 5 seconds, an alarm is generated
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--gta_profiles"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.gta_profiles`

Read-Only:

* `gta_profiles` (List of String)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--gtp_control_sampling"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.gtp_control_sampling`

Read-Only:

* `enabled` (Boolean) - When enabled, GTP Control plane traffic for the subscribers contained within the subscriber sample defined in GTP flowsample maps will be sent to tools. When disabled, all GTP Control plane traffic for all subscribers in GTP flowsample maps will be sent to tools.
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--gtp_flow"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.gtp_flow`

Read-Only:

* `timeout` (Number) - Session Timeout. in units of 10 minutes. Default of 48 is 8 hours
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--gtp_gpfcp_delay"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.gtp_gpfcp_delay`

Read-Only:

* `timeout` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--gtp_persistence"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.gtp_persistence`
...
* `interval` (Number) - GTP Persistence Interval(mins)
* `restart_age_time` (Number) - GTP Persistence Restart Age Time(mins)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--gtp_random_sampling"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.gtp_random_sampling`

Read-Only:

* `enabled` (Boolean) - When enabled, sampling of subscriber's sessions happens in random fashion
* `interval` (Number) - Rotation Interval in multiples of 12 (hrs)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--gtp_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.gtp_whitelist`

Read-Only:

* `multi_whitelists` (List of String) - Alias/Aliases of referenced GTP Whitelists.
* `whitelist` (String) - Alias of referenced GTP Whitelist.Deprecated since H 5.12
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--health_check"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.health_check`
...
* `round_trip_time` (Number)
* `src_port` (Number)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--hsm_group"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.hsm_group`

Read-Only:

* `hsm_group` (String) - alias of Hsm Group
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--ip_frag"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.ip_frag`
...
* `head_session_timeout` (Number) - in seconds
* `timeout` (Number) - in seconds
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--load_balance"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.load_balance`

Read-Only:

* `failover` (Attributes) - Private class. Failover part of the GsGroup Load Balancing Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--load_balance--failover))
* `link_weight_type` (String) - Controls LB port weight resolution for 'weighted' load balancing (wtRoundRobin, wtLeastBw, wtLeastPktRate, wtLeastConn, wtLeastTotalTraffic,wtImsi, wtSupi). For 'assigned', explicit user-configured port weights on the port group are used. For 'speed', link speed is used and user-assigned port weights are ignored. Ex: if a port group consists of four tool ports, and one of them is 100G and the others are 10G, the 100G link will be selected about 10 times more than the 10G links
* `replicate_gtpc` (Boolean) - Enables replication of GTP control packets (GTP-c)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--load_balance--failover"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.load_balance.failover`
...
* `threshold_lt_bw` (Number) - Mutually exclusive with 'thresholdLtPktRate'. Failover threshold for Least Bandwidth. In percent's of the maximum bandwidth of a tool port. Ex: for a 1G port, a failover threshold of 90% means that failover to another tool port occurs when the bandwidth reaches 900Mbps. The default is 80%
* `threshold_lt_pkt_rate` (Number) - Mutually exclusive with 'thresholdLtBw'. Failover threshold for Least Packet Rate. In In kilo-packets-per-second: \[500k..5M\] pps. A tool port will failover to another tool port when the packet rate is over the specified threshold, in packets per second. The default is 1M
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--netflow"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.netflow`

Read-Only:

* `monitor` (String) - Alias of referenced Netflow Monitor
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--node_role"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.node_role`
...
* `stand_alone_mode` (Boolean) - Enables UPN Stand-alone mode
* `type` (String)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--port_throttle_sip"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.port_throttle_sip`

Read-Only:

* `port_throttle` (String) - Alias of referenced Port Throttle
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--resource"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.resource`

Read-Only:

* `buffer_asf_size` (Number) - Session aware APF buffer. Valid values: 2-5: in million sessions (0 = disabled). Changes take effect after card or system reboot
* `cpu` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--resource--cpu))
* `hsm_ssl` (Attributes) - GsGroup Resource Hsm Ssl Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--resource--hsm_ssl))
* `inline_ssl` (Attributes) - Used to configure other GS apps in addition to Inline SSL on a HC1 box (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--resource--inline_ssl))
* `metadata` (Number) - flows in millions, how many flows to support for metadata. 0 to disable
* `packet_buffer` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--resource--packet_buffer))
* `session_overload` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--resource--session_overload))
* `tunnel_overload` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--resource--tunnel_overload))
* `xpkt_match` (Attributes) - GsGroup Resource Cross Packet Match Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--resource--xpkt_match))
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--resource--cpu"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.resource.cpu`

Read-Only:

* `overload_threshold` (Number) - Valid values 50 - 90%. 0 is disabled. Changes take effect after card or system reboot
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--resource--hsm_ssl"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.resource.hsm_ssl`
...
* `packet_buffer` (Number) - resource for application hsm-ssl packet-buffer per connection
* `session_count` (Number) - resource for application hsm-ssl buffer session count in million, 0 to disable
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--resource--inline_ssl"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.resource.inline_ssl`

Read-Only:

* `standalone` (Boolean) - If enabled , behaves in a normal way. If disabled, can configure other GS apps along side Inline ssl with Inline ssl occupying only 50% of the memory
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--resource--packet_buffer"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.resource.packet_buffer`

Read-Only:

* `overload_threshold` (Number) - Valid values 50 - 80%. 0 is disabled. Changes take effect after card or system reboot
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--resource--session_overload"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.resource.session_overload`

Read-Only:

* `overload_threshold` (Number) - Session overload threshold value , Default value is 90 and 0 is disabled.
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--resource--tunnel_overload"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.resource.tunnel_overload`

Read-Only:

* `overload_threshold` (Number) - Tunnel overload threshold value , Default value is 90 and 0 is disabled.
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--resource--xpkt_match"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.resource.xpkt_match`

Read-Only:

* `flows` (Number) - num in 100K flows. 0 is disable
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--rtp_ports"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.rtp_ports`

Read-Only:

* `range` (Attributes) - GsGroup Rtp Port Range Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--rtp_ports--range))
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--rtp_ports--range"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.rtp_ports.range`

Read-Only:

* `port` (Number)
* `port_max` (Number) - If specified should be greater than 'port'
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--sa_apf"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.sa_apf`

Read-Only:

* `buffer_size` (Number) - Session aware APF buffer. Valid values: 2-5: in million sessions (0 = disabled). Changes take effect after card or system reboot
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--session_logging"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.session_logging`
...
* `remote_syslog_ip` (String) - Remote Syslog IP
* `remote_syslog_port` (Number) - Remote Syslog Port Number
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--sffp_profiles"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.sffp_profiles`

Read-Only:

* `sffp_profiles` (List of String)
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--sip_media"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.sip_media`

Read-Only:

* `timeout` (Number) - Sip media timeout value in seconds .Valid values: 30-300.
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--sip_ports"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.sip_ports`

Read-Only:

* `ports` (List of Number) - list of TCP/UDP ports. Valid ports 1 - 65535. maximum 10 ports
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--sip_session"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.sip_session`

Read-Only:

* `timeout` (Number) - Sip session inactivity timer, value in seconds .Valid values: 30-300.
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--sip_tcp_idle_timeout"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.sip_tcp_idle_timeout`

Read-Only:

* `time` (Number) - Sip tcp idle timeout value in seconds .Valid values: 20-600.
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--sip_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.sip_whitelist`

Read-Only:

* `whitelist` (String) - Alias of referenced SIP Whitelist
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--ssl_decrypt"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.ssl_decrypt`

Read-Only:

* `decrypt_fail_action` (String)
* `enabled` (Boolean)
* `hsm_pkcs11` (Attributes) - GsGroup Ssl Decrypt Hsm Pkcs11 Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--gs_group_params--ssl_decrypt--hsm_pkcs11))
* `hsm_timeout` (Number) - in milliseconds
* `key_cache_timeout` (Number) - in seconds
* `key_map` (String) - references one of the pre-defined 'SslDecryptionKeyMap' groups
* `non_ssl_traffic` (String)
...
* `tcp_syn_timeout` (Number) - in seconds
* `ticket_cache_timeout` (Number) - in seconds
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--ssl_decrypt--hsm_pkcs11"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.ssl_decrypt.hsm_pkcs11`
...
* `dynamic_object` (Boolean) - hsm pkcs11 dynamic object
* `load_sharing` (Boolean) - hsm pkcs11 load sharing
<a id="nestedatt--policies--rules--gs_operations--gs_group_params--xpkt_match"></a>
### Nested Schema for `policies.rules.gs_operations.gs_group_params.xpkt_match`

Read-Only:

* `enabled` (Boolean)
<a id="nestedatt--policies--rules--gs_operations--templates"></a>
### Nested Schema for `policies.rules.gs_operations.templates`

Read-Only:

* `gs_apps` (Attributes) - GigaSMART Applications for a GSOP. At least one GsApp must be defined for the config to be valid (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps))
* `gs_group_params` (Attributes) - GsGroup Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params))
* `template_id` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps`

Read-Only:

* `apf` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--apf))
* `dedup` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--dedup))
* `diameter_whitelist` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--diameter_whitelist))
* `flow_filter` (Attributes) - GigaSMART 'Flow Filter' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--flow_filter))
* `flow_sampling` (Attributes) - GigaSMART 'Flow Sampling' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--flow_sampling))
* `gseries_header_add` (Attributes) - Only applicable for G-series (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_header_add))
* `gseries_header_remove` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_header_remove))
* `gseries_load_balance` (Attributes) - Only applicable for G-series per-rule GSOP (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_load_balance))
* `gseries_pattern_match` (Attributes) - Only applicable for G-series per-rule GSOP (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_pattern_match))
* `gtp_whitelist` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--gtp_whitelist))
* `header_add` (Attributes) - GigaSMART 'Add Header' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--header_add))
* `header_remove` (Attributes) - GigaSMART 'Remove Header' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--header_remove))
* `icap` (Attributes) - GigaSMART ICAP Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--icap))
* `inline_ssl` (Attributes) - GigaSMART Inline SSL Profile Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--inline_ssl))
* `load_balance` (Attributes) - GigaSMART 'Load Balancing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance))
* `masking` (Attributes) - GigaSMART 'Masking' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--masking))
* `metadata_export` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--metadata_export))
* `netflow` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--netflow))
* `sa_apf` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--sa_apf))
* `sip_whitelist` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--sip_whitelist))
* `slicing` (Attributes) - GigaSMART 'Slicing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--slicing))
* `ssl_decrypt` (Attributes) - GigaSMART 'SSL Decrypt' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--ssl_decrypt))
* `trailer_add` (Attributes) - GigaSMART 'Add Trailer' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--trailer_add))
* `trailer_remove` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--trailer_remove))
* `tunnel_decap` (Attributes) - GigaSMART 'Decapsulate Tunnel' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_decap))
* `tunnel_encap` (Attributes) - GigaSMART 'Encapsulate Tunnel' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap))
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--apf"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.apf`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--dedup"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.dedup`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--diameter_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.diameter_whitelist`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--flow_filter"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.flow_filter`

Read-Only:

* `type` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--flow_sampling"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.flow_sampling`

Read-Only:

* `type` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_header_add"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.gseries_header_add`

Read-Only:

* `types` (Set of String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_header_remove"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.gseries_header_remove`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_load_balance"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.gseries_load_balance`

Read-Only:

* `fixed_offset` (Attributes) - Per-rule Fixed Offset Load Balancing config for G-seres devices (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_load_balance--fixed_offset))
* `variable_offset` (Attributes) - Per-rule Variable Offset Load Balancing config for G-seres devices (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_load_balance--variable_offset))
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_load_balance--fixed_offset"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.gseries_load_balance.fixed_offset`
...
* `length` (Number)
* `offset` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_load_balance--variable_offset"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.gseries_load_balance.variable_offset`
...
* `start_delim` (String)
* `start_field` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_pattern_match"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.gseries_pattern_match`

Read-Only:

* `fixed_offset` (Attributes) - Per-rule Fixed Offset Pattern Match config for G-seres devices (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_pattern_match--fixed_offset))
* `variable_offset` (Attributes) - Per-rule Variable Offset Pattern Match config for G-seres devices (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_pattern_match--variable_offset))
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_pattern_match--fixed_offset"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.gseries_pattern_match.fixed_offset`

Read-Only:

* `length` (Number)
* `offset` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--gseries_pattern_match--variable_offset"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.gseries_pattern_match.variable_offset`

Read-Only:

* `end_delim` (String)
* `start_delim` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--gtp_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.gtp_whitelist`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--header_add"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.header_add`

Read-Only:

* `vlan` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--header_remove"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.header_remove`
...
* `vlan_header` (String) - Only valid when protocol is 'vlan'. Specifies the target vlan header to strip. Defaults to 'outer'
* `vxlan_id` (Number) - 24-bit value. Only valid when protocol is 'vxlan'. Specifies the vxlan id to strip. Value of '0' will strip all vxlan ids
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--icap"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.icap`

Read-Only:

* `icap_profile` (String) - Alias of referenced ICAP Profile
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--inline_ssl"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.inline_ssl`

Read-Only:

* `inline_ssl_profile` (String) - Alias of referenced Inline SSL Profile
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.load_balance`

Read-Only:

* `enhanced` (Attributes) - Private class. Enhanced part of the GigaSMART 'Load Balancing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance--enhanced))
* `stateful` (Attributes) - Private class. Stateful part of the GigaSMART 'Load Balancing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance--stateful))
* `stateless` (Attributes) - Private class. Stateless part of the GigaSMART 'Load Balancing' Application Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance--stateless))
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance--enhanced"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.load_balance.enhanced`

Read-Only:

* `elb_alias` (String) - elb app alias
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance--stateful"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.load_balance.stateful`

Read-Only:

* `app_type` (String) - 'sapf' option is added in release H 4.3.01. 'sip' and 'tunnel' added in release H 5.1. 'diameter' is added in release H 5.5
* `diameter_key_hash_type` (String) - required when 'appType' == 'diameter' and 'lbType' == 'diameterKeyHash'
* `diameter_key_multi_hash_type` (Attributes List) - required when 'appType' == 'diameter' and 'lbType' == 'diameterKeyMultiHash' (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance--stateful--diameter_key_multi_hash_type))
* `gtp_key_hash_type` (String) - required when 'appType' == 'gtp' and 'lbType' == 'gtpKeyHash'. ignored otherwise
* `lb_type` (String) - 'gtpKeyHash' is only applicable when 'appType' == 'gtp'. 'sipKeyHash' is only applicable when 'appType' == 'sip'
* `sip_key_hash_type` (String) - required when 'appType' == 'sip' and 'lbType' == 'sipKeyHash'. ignored otherwise
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance--stateful--diameter_key_multi_hash_type"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.load_balance.stateful.diameter_key_multi_hash_type`

Read-Only:

* `avp_codevalue` (Number) - required when 'key' == 'avpCode'
* `key` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--load_balance--stateless"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.load_balance.stateless`

Read-Only:

* `field_location` (String) - Ignored when 'hashFields' == 'gtpuTeid'. Required otherwise
* `hash_fields` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--masking"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.masking`
...
* `pattern` (String) - 1-byte hex mask, not applicable for protocol 'sip' valid and required otherwise
* `protocol` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--metadata_export"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.metadata_export`

Read-Only:

* `cache` (String) - metadata cache alias. cache should have exporters defined, and the exporters should have applicationProfiles defined
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--netflow"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.netflow`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--sa_apf"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.sa_apf`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--sip_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.sip_whitelist`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--slicing"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.slicing`
...
* `offset` (Number) - min offset is 64 for 'none'; 4 for protocol-referenced offsets. required property till H 5.6
* `protocol` (String) - required property till H 5.6
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--ssl_decrypt"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.ssl_decrypt`

Read-Only:

* `in_port` (Number) - Port number of 0 represents 'any' port
* `out_port` (Number) - Port number of 0 represents 'auto' port
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--trailer_add"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.trailer_add`

Read-Only:

* `types` (Set of String) - 'crc' is not applicable for G-series
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--trailer_remove"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.trailer_remove`

Read-Only:

* `enabled` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_decap"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.tunnel_decap`

Read-Only:

* `custom` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_decap--custom))
* `erspan_flow_id` (Number) - only applicable for 'erspan', A Flow ID of 0 decapsulates all ERSPAN tunnel traffic regardless of Flow ID
* `gmip_port` (Number) - only applicable for 'gmip', in which case it is required. Specifies the UDP port on which the Tunnel Network port on the receiving GigaVUE H Series is listening. Must match the configuration of the portdst configured on the sending end of the tunnel
* `l2_gre_key` (Number) - only applicable for 'l2gre', in which case it is required.
* `tls_pcapng` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_decap--tls_pcapng))
* `type` (String)
* `vxlan` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_decap--vxlan))
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_decap--custom"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.tunnel_decap.custom`

Read-Only:

* `port_dst` (Number) - when specified as 0, no validation will be done in the packet.
* `port_src` (Number) - when specified as 0, no validation will be done in the packet.
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_decap--tls_pcapng"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.tunnel_decap.tls_pcapng`

Read-Only:

* `decap_key` (String)
* `listener` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_decap--vxlan"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.tunnel_decap.vxlan`
...
* `port_src` (Number) - when specified as 0, no validation will be done in the packet.
* `vni` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.tunnel_encap`

Read-Only:

* `gmip_config` (Attributes) - Configuration for GMIP Tunnel Encapsulate GigaSmaprt App (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap--gmip_config))
* `l2_gre_config` (Attributes) - Configuration for l2GRE Tunnel Encapsulate GigaSmaprt App (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap--l2_gre_config))
* `tls_pcapng` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap--tls_pcapng))
* `type` (String)
* `vxlan_config` (Attributes) - Configuration for Vxlan Tunnel Encapsulate GigaSmaprt App (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap--vxlan_config))
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap--gmip_config"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.tunnel_encap.gmip_config`
...
* `src_port` (Number)
* `ttl` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap--l2_gre_config"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.tunnel_encap.l2_gre_config`
...
* `session_pos` (String) - required if 'sessionField' is specified
* `ttl` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap--tls_pcapng"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.tunnel_encap.tls_pcapng`

Read-Only:

* `exporter` (String)
* `exporter_group` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_apps--tunnel_encap--vxlan_config"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_apps.tunnel_encap.vxlan_config`
...
* `ttl` (Number)
* `vni` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params`

Read-Only:

* `app_tcp` (Attributes) - GsGroup TCP Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--app_tcp))
* `dedup` (Attributes) - GsGroup Dedup Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--dedup))
* `diameter_packet` (Attributes) - GsGroup Diameter Packet Timeout Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--diameter_packet))
* `diameter_s6_a_session` (Attributes) - GsGroup Diameter s6a Session Timeout Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--diameter_s6_a_session))
* `diameter_whitelist` (Attributes) - GsGroup Diameter Whitelist Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--diameter_whitelist))
* `eflow` (Attributes) - GsGroup Eflow Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--eflow))
* `engine_watchdog_timer` (Attributes) - GsGroup EngineWatchdogTimer Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--engine_watchdog_timer))
* `erspan3` (Attributes) - GsGroup ERSPAN III Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--erspan3))
* `flow_mask` (Attributes) - GsGroup Flow Mask Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--flow_mask))
* `flow_sampling` (Attributes) - GsGroup Flow Sampling Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--flow_sampling))
* `generic_session_timeout` (Attributes) - GsGroup Generic Session Timeout Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--generic_session_timeout))
* `gpfcp_profiles` (Attributes) - Enriched CUPS Gpfcp profile aliases (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--gpfcp_profiles))
* `gs_group_system` (Attributes) - GsGroup System Monitoring Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--gs_group_system))
* `gta_profiles` (Attributes) - 3GPP CUPS gta profile aliases (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--gta_profiles))
* `gtp_control_sampling` (Attributes) - GsGroup Gtp Control Sampling Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_control_sampling))
* `gtp_flow` (Attributes) - GsGroup Gtp Flow Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_flow))
* `gtp_gpfcp_delay` (Attributes) - GsGroup Gtp GPFCP Delay time (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_gpfcp_delay))
* `gtp_persistence` (Attributes) - GsGroup Gtp Persistence Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_persistence))
* `gtp_random_sampling` (Attributes) - GsGroup Gtp Random Sampling Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_random_sampling))
* `gtp_whitelist` (Attributes) - GsGroup GTP Whitelist Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_whitelist))
* `health_check` (Attributes) - health check configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--health_check))
* `hsm_group` (Attributes) - GsGroup Hsm Group Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--hsm_group))
* `ip_frag` (Attributes) - GsGroup IP Fragmentation Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--ip_frag))
* `load_balance` (Attributes) - GsGroup Load Balancing Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--load_balance))
* `netflow` (Attributes) - GsGroup Netflow Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--netflow))
* `node_role` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--node_role))
* `port_throttle_sip` (Attributes) - GsGroup SIP Port Throttle Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--port_throttle_sip))
* `resource` (Attributes) - GsGroup Resource Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource))
* `rtp_ports` (Attributes) - GsGroup Rtp Ports Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--rtp_ports))
* `sa_apf` (Attributes) - GsGroup Session Aware APF Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--sa_apf))
* `session_logging` (Attributes) - GsGroup Session Logging Configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--session_logging))
* `sffp_profiles` (Attributes) - 3GPP CUPS sffp profile aliases (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--sffp_profiles))
* `sip_media` (Attributes) - GsGroup Sip Media Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_media))
* `sip_ports` (Attributes) - GsGroup Sip Ports Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_ports))
* `sip_session` (Attributes) - GsGroup Sip Session Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_session))
* `sip_tcp_idle_timeout` (Attributes) - GsGroup Sip Tcp Idle Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_tcp_idle_timeout))
* `sip_whitelist` (Attributes) - GsGroup SIP Whitelist Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_whitelist))
* `ssl_decrypt` (Attributes) - GsGroup SSL Decrypt Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--ssl_decrypt))
* `xpkt_match` (Attributes) - cross packet match configuration (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--xpkt_match))
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--app_tcp"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.app_tcp`
...
* `load_balance` (Boolean) - Enables TCP loadbalancing for the Tool Ports. Supports SIP & N11 only
* `tcp_control` (String) - To choose the action on TCP Control messages
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--dedup"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.dedup`
...
* `timer` (Number) - in microseconds
* `vlan` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--diameter_packet"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.diameter_packet`

Read-Only:

* `timeout` (Number) - timeout in seconds to remove OOO or fragmented packet
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--diameter_s6_a_session"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.diameter_s6_a_session`

Read-Only:

* `limit` (Number) - Number of sessions to allocate for Diameter S6A
* `timeout` (Number) - timeout in seconds used to clean inactive sessions
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--diameter_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.diameter_whitelist`

Read-Only:

* `whitelist` (String) - Alias of referenced diameter Whitelist
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--eflow"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.eflow`
...
* `packet_count` (Number) - Number of packets to be received by a flow
* `packet_ratio` (Number) - Percentage of packets in a flow vs overall packet count
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--engine_watchdog_timer"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.engine_watchdog_timer`

Read-Only:

* `time` (Number) - Engine Watchdog Timer value, time to restart in seconds .Valid values: 60-600. 0 is disable
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--erspan3"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.erspan3`

Read-Only:

* `timestamp_format` (String) - erspan III tunnelDecap timestamp format
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--flow_mask"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.flow_mask`
...
* `length` (Number)
* `offset` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--flow_sampling"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.flow_sampling`
...
* `timeout` (Number) - in minutes
* `type` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--generic_session_timeout"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.generic_session_timeout`

Read-Only:

* `time` (Number) - Maximum timeout for session entry
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--gpfcp_profiles"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.gpfcp_profiles`

Read-Only:

* `g_pfcp_profiles` (List of String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--gs_group_system"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.gs_group_system`

Read-Only:

* `cpu_load_alarm_threshold` (Number) - CPU rising threshold percentage 20-99%. Once this threshold is crossed for 5 seconds, an alarm is generated
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--gta_profiles"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.gta_profiles`

Read-Only:

* `gta_profiles` (List of String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_control_sampling"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.gtp_control_sampling`

Read-Only:

* `enabled` (Boolean) - When enabled, GTP Control plane traffic for the subscribers contained within the subscriber sample defined in GTP flowsample maps will be sent to tools. When disabled, all GTP Control plane traffic for all subscribers in GTP flowsample maps will be sent to tools.
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_flow"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.gtp_flow`

Read-Only:

* `timeout` (Number) - Session Timeout. in units of 10 minutes. Default of 48 is 8 hours
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_gpfcp_delay"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.gtp_gpfcp_delay`

Read-Only:

* `timeout` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_persistence"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.gtp_persistence`
...
* `interval` (Number) - GTP Persistence Interval(mins)
* `restart_age_time` (Number) - GTP Persistence Restart Age Time(mins)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_random_sampling"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.gtp_random_sampling`

Read-Only:

* `enabled` (Boolean) - When enabled, sampling of subscriber's sessions happens in random fashion
* `interval` (Number) - Rotation Interval in multiples of 12 (hrs)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--gtp_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.gtp_whitelist`

Read-Only:

* `multi_whitelists` (List of String) - Alias/Aliases of referenced GTP Whitelists.
* `whitelist` (String) - Alias of referenced GTP Whitelist.Deprecated since H 5.12
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--health_check"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.health_check`
...
* `round_trip_time` (Number)
* `src_port` (Number)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--hsm_group"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.hsm_group`

Read-Only:

* `hsm_group` (String) - alias of Hsm Group
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--ip_frag"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.ip_frag`
...
* `head_session_timeout` (Number) - in seconds
* `timeout` (Number) - in seconds
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--load_balance"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.load_balance`

Read-Only:

* `failover` (Attributes) - Private class. Failover part of the GsGroup Load Balancing Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--load_balance--failover))
* `link_weight_type` (String) - Controls LB port weight resolution for 'weighted' load balancing (wtRoundRobin, wtLeastBw, wtLeastPktRate, wtLeastConn, wtLeastTotalTraffic,wtImsi, wtSupi). For 'assigned', explicit user-configured port weights on the port group are used. For 'speed', link speed is used and user-assigned port weights are ignored. Ex: if a port group consists of four tool ports, and one of them is 100G and the others are 10G, the 100G link will be selected about 10 times more than the 10G links
* `replicate_gtpc` (Boolean) - Enables replication of GTP control packets (GTP-c)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--load_balance--failover"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.load_balance.failover`
...
* `threshold_lt_bw` (Number) - Mutually exclusive with 'thresholdLtPktRate'. Failover threshold for Least Bandwidth. In percent's of the maximum bandwidth of a tool port. Ex: for a 1G port, a failover threshold of 90% means that failover to another tool port occurs when the bandwidth reaches 900Mbps. The default is 80%
* `threshold_lt_pkt_rate` (Number) - Mutually exclusive with 'thresholdLtBw'. Failover threshold for Least Packet Rate. In In kilo-packets-per-second: \[500k..5M\] pps. A tool port will failover to another tool port when the packet rate is over the specified threshold, in packets per second. The default is 1M
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--netflow"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.netflow`

Read-Only:

* `monitor` (String) - Alias of referenced Netflow Monitor
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--node_role"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.node_role`
...
* `stand_alone_mode` (Boolean) - Enables UPN Stand-alone mode
* `type` (String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--port_throttle_sip"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.port_throttle_sip`

Read-Only:

* `port_throttle` (String) - Alias of referenced Port Throttle
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.resource`

Read-Only:

* `buffer_asf_size` (Number) - Session aware APF buffer. Valid values: 2-5: in million sessions (0 = disabled). Changes take effect after card or system reboot
* `cpu` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--cpu))
* `hsm_ssl` (Attributes) - GsGroup Resource Hsm Ssl Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--hsm_ssl))
* `inline_ssl` (Attributes) - Used to configure other GS apps in addition to Inline SSL on a HC1 box (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--inline_ssl))
* `metadata` (Number) - flows in millions, how many flows to support for metadata. 0 to disable
* `packet_buffer` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--packet_buffer))
* `session_overload` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--session_overload))
* `tunnel_overload` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--tunnel_overload))
* `xpkt_match` (Attributes) - GsGroup Resource Cross Packet Match Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--xpkt_match))
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--cpu"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.resource.cpu`

Read-Only:

* `overload_threshold` (Number) - Valid values 50 - 90%. 0 is disabled. Changes take effect after card or system reboot
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--hsm_ssl"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.resource.hsm_ssl`
...
* `packet_buffer` (Number) - resource for application hsm-ssl packet-buffer per connection
* `session_count` (Number) - resource for application hsm-ssl buffer session count in million, 0 to disable
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--inline_ssl"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.resource.inline_ssl`

Read-Only:

* `standalone` (Boolean) - If enabled , behaves in a normal way. If disabled, can configure other GS apps along side Inline ssl with Inline ssl occupying only 50% of the memory
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--packet_buffer"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.resource.packet_buffer`

Read-Only:

* `overload_threshold` (Number) - Valid values 50 - 80%. 0 is disabled. Changes take effect after card or system reboot
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--session_overload"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.resource.session_overload`

Read-Only:

* `overload_threshold` (Number) - Session overload threshold value , Default value is 90 and 0 is disabled.
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--tunnel_overload"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.resource.tunnel_overload`

Read-Only:

* `overload_threshold` (Number) - Tunnel overload threshold value , Default value is 90 and 0 is disabled.
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--resource--xpkt_match"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.resource.xpkt_match`

Read-Only:

* `flows` (Number) - num in 100K flows. 0 is disable
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--rtp_ports"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.rtp_ports`

Read-Only:

* `range` (Attributes) - GsGroup Rtp Port Range Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--rtp_ports--range))
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--rtp_ports--range"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.rtp_ports.range`

Read-Only:

* `port` (Number)
* `port_max` (Number) - If specified should be greater than 'port'
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--sa_apf"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.sa_apf`

Read-Only:

* `buffer_size` (Number) - Session aware APF buffer. Valid values: 2-5: in million sessions (0 = disabled). Changes take effect after card or system reboot
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--session_logging"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.session_logging`
...
* `remote_syslog_ip` (String) - Remote Syslog IP
* `remote_syslog_port` (Number) - Remote Syslog Port Number
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--sffp_profiles"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.sffp_profiles`

Read-Only:

* `sffp_profiles` (List of String)
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_media"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.sip_media`

Read-Only:

* `timeout` (Number) - Sip media timeout value in seconds .Valid values: 30-300.
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_ports"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.sip_ports`

Read-Only:

* `ports` (List of Number) - list of TCP/UDP ports. Valid ports 1 - 65535. maximum 10 ports
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_session"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.sip_session`

Read-Only:

* `timeout` (Number) - Sip session inactivity timer, value in seconds .Valid values: 30-300.
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_tcp_idle_timeout"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.sip_tcp_idle_timeout`

Read-Only:

* `time` (Number) - Sip tcp idle timeout value in seconds .Valid values: 20-600.
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--sip_whitelist"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.sip_whitelist`

Read-Only:

* `whitelist` (String) - Alias of referenced SIP Whitelist
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--ssl_decrypt"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.ssl_decrypt`

Read-Only:

* `decrypt_fail_action` (String)
* `enabled` (Boolean)
* `hsm_pkcs11` (Attributes) - GsGroup Ssl Decrypt Hsm Pkcs11 Parameters (see [below for nested schema](#nestedatt--policies--rules--gs_operations--templates--gs_group_params--ssl_decrypt--hsm_pkcs11))
* `hsm_timeout` (Number) - in milliseconds
* `key_cache_timeout` (Number) - in seconds
* `key_map` (String) - references one of the pre-defined 'SslDecryptionKeyMap' groups
* `non_ssl_traffic` (String)
...
* `tcp_syn_timeout` (Number) - in seconds
* `ticket_cache_timeout` (Number) - in seconds
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--ssl_decrypt--hsm_pkcs11"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.ssl_decrypt.hsm_pkcs11`
...
* `dynamic_object` (Boolean) - hsm pkcs11 dynamic object
* `load_sharing` (Boolean) - hsm pkcs11 load sharing
<a id="nestedatt--policies--rules--gs_operations--templates--gs_group_params--xpkt_match"></a>
### Nested Schema for `policies.rules.gs_operations.templates.gs_group_params.xpkt_match`

Read-Only:

* `enabled` (Boolean)
<a id="nestedatt--policies--rules--health_state_reasons"></a>
### Nested Schema for `policies.rules.health_state_reasons`
...
* `severity` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `traffic_health_state_computation_type` (String) - Traffic Health State Computation Type
<a id="nestedatt--policies--rules--matches"></a>
### Nested Schema for `policies.rules.matches`

Read-Only:

* `aggregate_filters` (Attributes List) (see [below for nested schema](#nestedatt--policies--rules--matches--aggregate_filters))
* `operation_type` (String)
* `rule_criteria_id` (String)
<a id="nestedatt--policies--rules--matches--aggregate_filters"></a>
### Nested Schema for `policies.rules.matches.aggregate_filters`

Read-Only:

* `name` (String)
* `operation_type` (String)
* `simple_filters` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--matches--aggregate_filters--simple_filters))
* `template_id` (String)
<a id="nestedatt--policies--rules--matches--aggregate_filters--simple_filters"></a>
### Nested Schema for `policies.rules.matches.aggregate_filters.simple_filters`

Read-Only:

* `advanced_filter_properties` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--matches--aggregate_filters--simple_filters--advanced_filter_properties))
* `type` (String)
* `values` (Attributes) (see [below for nested schema](#nestedatt--policies--rules--matches--aggregate_filters--simple_filters--values))
<a id="nestedatt--policies--rules--matches--aggregate_filters--simple_filters--advanced_filter_properties"></a>
### Nested Schema for `policies.rules.matches.aggregate_filters.simple_filters.advanced_filter_properties`

Read-Only:

* `key` (String)
* `values` (List of Dynamic)
<a id="nestedatt--policies--rules--matches--aggregate_filters--simple_filters--values"></a>
### Nested Schema for `policies.rules.matches.aggregate_filters.simple_filters.values`
...
* `value` (String)
* `value_max` (String)
<a id="nestedatt--policies--rules--tools"></a>
### Nested Schema for `policies.rules.tools`
...
* `is_port` (Boolean) - destination alias is a port (tool or hybrid)
* `via_gsop` (Boolean) - Policy has GigaSMART operation
<a id="nestedatt--policies--src_ports_info"></a>
### Nested Schema for `policies.src_ports_info`
...
```shell
terraform import gigavuecore_intent_policy.example {name}
```
