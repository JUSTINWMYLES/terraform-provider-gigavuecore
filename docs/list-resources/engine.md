---
page_title: "gigavuecore_engine List Resource - gigavuecore"
subcategory: ""
description: |-
  Load all GigaSMART ports interface details
---

# gigavuecore_engine List Resource
...
```terraform
list "gigavuecore_engine" "example" {
...
* `eport` (String, computed) - GigaSMART engine port
