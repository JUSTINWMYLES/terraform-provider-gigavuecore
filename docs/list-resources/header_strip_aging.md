---
page_title: "gigavuecore_header_strip_aging List Resource - gigavuecore"
subcategory: ""
description: |-
  Load header strip aging for all boxes
---

# gigavuecore_header_strip_aging List Resource
...
```terraform
list "gigavuecore_header_strip_aging" "example" {
