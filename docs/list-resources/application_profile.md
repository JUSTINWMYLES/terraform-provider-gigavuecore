---
page_title: "gigavuecore_application_profile List Resource - gigavuecore"
subcategory: ""
description: |-
  Load All Metadata Application Profiles
---

# gigavuecore_application_profile List Resource
...
```terraform
list "gigavuecore_application_profile" "example" {
