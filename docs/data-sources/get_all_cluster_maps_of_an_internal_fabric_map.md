...
* `afm_map` (Attributes) (see [below for nested schema](#nestedatt--items--afm_map))
...
* `vlan_tag` (Attributes) (see [below for nested schema](#nestedatt--items--afm_map--vlan_tag))
...
* `rule_id` (Number)
* `vlan_tag` (Attributes) (see [below for nested schema](#nestedatt--items--afm_map--rules--drop_rules--vlan_tag))
...
* `rule_id` (Number)
* `vlan_tag` (Attributes) (see [below for nested schema](#nestedatt--items--afm_map--rules--pass_rules--vlan_tag))
