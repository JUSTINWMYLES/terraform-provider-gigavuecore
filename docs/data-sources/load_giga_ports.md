...
* `ports` (Attributes List, computed) (see [below for nested schema](#nestedatt--ports))
...
* `gsparams` (Attributes) - Gsparams Resource HW limit for engine port (see [below for nested schema](#nestedatt--ports--gsparams))
...
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--ports--health_state_reasons))
...
* `sfp` (Attributes) - Port SFP details (see [below for nested schema](#nestedatt--ports--sfp))
* `ude` (Attributes) - Unidirectional Ethernet (see [below for nested schema](#nestedatt--ports--ude))
<a id="nestedatt--ports--gsparams"></a>
### Nested Schema for `ports.gsparams`

Read-Only:

* `bufferasf` (Attributes) (see [below for nested schema](#nestedatt--ports--gsparams--bufferasf))
* `metadata` (Attributes) (see [below for nested schema](#nestedatt--ports--gsparams--metadata))
<a id="nestedatt--ports--gsparams--bufferasf"></a>
### Nested Schema for `ports.gsparams.bufferasf`
...
* `max` (Number)
* `min` (Number)
<a id="nestedatt--ports--gsparams--metadata"></a>
### Nested Schema for `ports.gsparams.metadata`
...
* `max` (Number)
* `min` (Number)
<a id="nestedatt--ports--health_state_reasons"></a>
### Nested Schema for `ports.health_state_reasons`
...
<a id="nestedatt--ports--sfp"></a>
### Nested Schema for `ports.sfp`
...
* `vendor_pn` (String)
* `vendor_sn` (String)
<a id="nestedatt--ports--ude"></a>
### Nested Schema for `ports.ude`
