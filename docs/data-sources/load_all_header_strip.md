...
* `header_strips_def` (Attributes List, computed) (see [below for nested schema](#nestedatt--header_strips_def))
...
<a id="nestedatt--header_strips_def"></a>
### Nested Schema for `header_strips_def`
