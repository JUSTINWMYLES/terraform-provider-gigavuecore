...
* `expired_licenses_exist` (Bool, computed)
* `expiry_alerts_last_sent_on` (Number, computed)
* `license_expiry_alert_enabled` (Bool, computed)
...
* `other_upcoming_renewals_receivers` (List(String), computed)
* `other_vbl_report_receivers` (List(String), computed)
* `volume_usage_alert_enabled` (Bool, computed)
