...
* `metadata_exporters` (List(Object({alias, application_profiles, cef, description, destination, max_pkt_size, mobility_sam, monitor, netflow, snmp, source, type})), computed)
