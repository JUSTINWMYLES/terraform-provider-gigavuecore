...
* `comment` (String) - User comments for the config file
...
* `family` (String) - \['H' or 'G'\]: identifies whether this is an H-series or a G-series Config file
* `filename` (String) - Bulk Replicate config file name
