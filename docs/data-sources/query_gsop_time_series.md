---
page_title: "gigavuecore_query_gsop_time_series Data Source - gigavuecore"
subcategory: ""
description: |-
  GSOP Time Series Query interface
---

# gigavuecore_query_gsop_time_series Data Source
...
```terraform
data "gigavuecore_query_gsop_time_series" "example" {
  cluster     = "example"
  end_time    = "example"
  gs_group    = "example"
  gsop        = "example"
...
* `gsop` (String, optional) - GSOP alias to filter by. Value of '\*' indicates a 'group-by-gsop' request. Multiple values separated by '\|' can be specified, in which case time series are filtered and grouped by the requested GSOP
