...
* `application_profiles` (List(Object({alias, application_id, applications, counter, datalink, description, flow, gtpu, interface, ip, ipv4, ipv6, outer_ipv4, outer_ipv6, timestamp, transport, type})), computed)
