...
* `control_only_session` (Attributes, computed) (see [below for nested schema](#nestedatt--control_only_session))
* `control_tunnels` (Attributes, computed) (see [below for nested schema](#nestedatt--control_tunnels))
* `control_user_tunnels` (Attributes, computed) (see [below for nested schema](#nestedatt--control_user_tunnels))
...
* `pending_session` (Attributes, computed) (see [below for nested schema](#nestedatt--pending_session))
