...
* `cards` (Attributes List, computed) (see [below for nested schema](#nestedatt--cards))
...
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--cards--health_state_reasons))
* `hw_revision` (String)
* `hw_type` (String)
* `mode` (String)
* `oper_status` (String)
* `pld_info` (Attributes) (see [below for nested schema](#nestedatt--cards--pld_info))
* `power_priority` (Number) - Power slot Priority
* `power_req` (Number) - watt
* `product_code` (String)
* `serial_number` (String)
* `slot_id` (String) - device card slot id
* `temperatures` (Attributes) (see [below for nested schema](#nestedatt--cards--temperatures))
* `voltages` (Attributes List) (see [below for nested schema](#nestedatt--cards--voltages))
<a id="nestedatt--cards--health_state_reasons"></a>
### Nested Schema for `cards.health_state_reasons`
...
<a id="nestedatt--cards--pld_info"></a>
### Nested Schema for `cards.pld_info`

Read-Only:

* `need_upgrade` (Boolean)
* `pld_revision` (String) - PLD revision
<a id="nestedatt--cards--temperatures"></a>
### Nested Schema for `cards.temperatures`
...
<a id="nestedatt--cards--voltages"></a>
### Nested Schema for `cards.voltages`
