---
page_title: "gigavuecore_get_all_cluster_circuit_tunnels_of_an_user_fabric_map Data Source - gigavuecore"
subcategory: ""
description: |-
  Get all cluster circuit tunnel endpoints of a user-defined fabric map
---

# gigavuecore_get_all_cluster_circuit_tunnels_of_an_user_fabric_map Data Source
...
```terraform
data "gigavuecore_get_all_cluster_circuit_tunnels_of_an_user_fabric_map" "example" {
  alias = "example"
  mode  = "example"
  type  = "example"
}
...
* `circuit_tunnel` (Attributes) - Detailed definition of this circuit tunnel endpoint (see [below for nested schema](#nestedatt--items--circuit_tunnel))
...
<a id="nestedatt--items--circuit_tunnel"></a>
### Nested Schema for `items.circuit_tunnel`
