...
* `traffic_policy_graphs` (List(Object({alias, comment, end_points, health_state, health_state_reasons, tags, traffic_flows, traffic_health_state, traffic_health_state_reasons})), computed)
