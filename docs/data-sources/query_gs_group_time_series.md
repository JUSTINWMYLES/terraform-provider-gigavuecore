---
page_title: "gigavuecore_query_gs_group_time_series Data Source - gigavuecore"
subcategory: ""
description: |-
  GsGroup Time Series Query interface
---

# gigavuecore_query_gs_group_time_series Data Source
...
```terraform
data "gigavuecore_query_gs_group_time_series" "example" {
  cluster     = "example"
  end_time    = "example"
  gs_group    = "example"
  max_points  = 0
  max_series  = 0
  metric      = "gsGroup.octets"
  rate        = true
  since       = "example"
  sort_by     = "example"
  start_time  = "example"
