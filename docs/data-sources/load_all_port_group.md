...
* `port_groups` (List(Object({alias, cluster_id, comment, gigastreams, health_state, health_state_reasons, port_weights, ports, smart_lb, tunnel_lb_endpoints})), computed)
