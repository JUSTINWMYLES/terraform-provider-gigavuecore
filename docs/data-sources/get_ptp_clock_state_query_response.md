...
* `clock_quality` (Object({accuracy, class, offset}), computed) - Clock Quality determines the quality of a clock based on class and accuracy. Used to select source clock in Best Source Clock Algorithm
