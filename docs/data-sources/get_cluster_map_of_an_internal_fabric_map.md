---
page_title: "gigavuecore_get_cluster_map_of_an_internal_fabric_map Data Source - gigavuecore"
subcategory: ""
description: |-
  Get a cluster map of an internal fabric map
---

# gigavuecore_get_cluster_map_of_an_internal_fabric_map Data Source
...
```terraform
data "gigavuecore_get_cluster_map_of_an_internal_fabric_map" "example" {
  alias     = "example"
  cm_alias  = "example"
  ifm_alias = "example"
}
...
* `afm_map` (Attributes, computed) - Detailed definition of this map (see [below for nested schema](#nestedatt--afm_map))
...
* `fabric_map_aliases` (List of String, computed) - Aliases of the fabric maps that this map supports.
...
* `vlan_tag` (Attributes) - This field is only valid for 'regular/byRule', 'collector' map types (see [below for nested schema](#nestedatt--afm_map--vlan_tag))
...
* `rule_id` (Number)
* `vlan_tag` (Attributes) - This field is only  applicable for pass rules (see [below for nested schema](#nestedatt--afm_map--rules--drop_rules--vlan_tag))
...
* `rule_id` (Number)
* `vlan_tag` (Attributes) - This field is only  applicable for pass rules (see [below for nested schema](#nestedatt--afm_map--rules--pass_rules--vlan_tag))
