...
* `port_configs` (Attributes List, computed) (see [below for nested schema](#nestedatt--port_configs))
...
<a id="nestedatt--port_configs"></a>
### Nested Schema for `port_configs`

Read-Only:

* `access_roles` (Attributes) - Port Access RBAC definitions (see [below for nested schema](#nestedatt--port_configs--access_roles))
* `alarm_thresholds` (Attributes) - Port Alarm Thresholds definitions (see [below for nested schema](#nestedatt--port_configs--alarm_thresholds))
...
* `lock` (Attributes) - Port Locking definitions (see [below for nested schema](#nestedatt--port_configs--lock))
* `mpls_advanced` (Attributes) - Select a combination of Mpls-Advanced options (see [below for nested schema](#nestedatt--port_configs--mpls_advanced))
* `neighbor_discovery` (String) - Configures port neighbor discovery options
* `port_id` (String) - device port id
* `ptp` (Attributes) - Port PTP configurations (see [below for nested schema](#nestedatt--port_configs--ptp))
* `share` (Attributes) - Port Sharing definitions (see [below for nested schema](#nestedatt--port_configs--share))
...
* `timestamp` (Attributes) - Timestamping definitions for GigaPORT-X12-TS ports (see [below for nested schema](#nestedatt--port_configs--timestamp))
* `vxlan_id` (Number) - Value of 0 disables the vxlanId
<a id="nestedatt--port_configs--access_roles"></a>
### Nested Schema for `port_configs.access_roles`
...
<a id="nestedatt--port_configs--alarm_thresholds"></a>
### Nested Schema for `port_configs.alarm_thresholds`
...
<a id="nestedatt--port_configs--lock"></a>
### Nested Schema for `port_configs.lock`
...
<a id="nestedatt--port_configs--mpls_advanced"></a>
### Nested Schema for `port_configs.mpls_advanced`

Read-Only:

* `mpls_advanced_opt` (Attributes List) - List of Mpls-Advanced Options (see [below for nested schema](#nestedatt--port_configs--mpls_advanced--mpls_advanced_opt))
<a id="nestedatt--port_configs--mpls_advanced--mpls_advanced_opt"></a>
### Nested Schema for `port_configs.mpls_advanced.mpls_advanced_opt`

Read-Only:

* `adv_opt` (String) - Mpls-Advanced Options
<a id="nestedatt--port_configs--ptp"></a>
### Nested Schema for `port_configs.ptp`
...
* `timestamp` (Attributes) - Port PTP timestamp configurations (see [below for nested schema](#nestedatt--port_configs--ptp--timestamp))
* `vlan` (Number) - configures vlan on the PTP configured port
<a id="nestedatt--port_configs--ptp--timestamp"></a>
### Nested Schema for `port_configs.ptp.timestamp`

Read-Only:

* `egress` (Attributes) (see [below for nested schema](#nestedatt--port_configs--ptp--timestamp--egress))
* `ingress` (Attributes) (see [below for nested schema](#nestedatt--port_configs--ptp--timestamp--ingress))
<a id="nestedatt--port_configs--ptp--timestamp--egress"></a>
### Nested Schema for `port_configs.ptp.timestamp.egress`
...
<a id="nestedatt--port_configs--ptp--timestamp--ingress"></a>
### Nested Schema for `port_configs.ptp.timestamp.ingress`

Read-Only:

* `insert` (Boolean) - When set, will insert timestamp for packets on the port
* `source_id` (Number) - Source identifier of Packet Time Stamp record header
<a id="nestedatt--port_configs--share"></a>
### Nested Schema for `port_configs.share`
...
<a id="nestedatt--port_configs--timestamp"></a>
### Nested Schema for `port_configs.timestamp`
