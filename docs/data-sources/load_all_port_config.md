...
* `egress` (Attributes) - Tx (Egress) settings (see [below for nested schema](#nestedatt--items--ptp--timestamp--egress))
* `ingress` (Attributes) - Rx (Ingress) settings (see [below for nested schema](#nestedatt--items--ptp--timestamp--ingress))
