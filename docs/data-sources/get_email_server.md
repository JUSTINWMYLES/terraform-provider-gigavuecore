...
* `enable_auto_support_notif` (Boolean, computed) - Enable Auto Support Notifications
* `enable_smtp_auth` (Boolean, computed) - Enable SMTP auth
* `include_hostname` (Boolean, computed) - Include Hostname
