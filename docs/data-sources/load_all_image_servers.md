...
* `image_servers` (Attributes List, computed) (see [below for nested schema](#nestedatt--image_servers))
...
<a id="nestedatt--image_servers"></a>
### Nested Schema for `image_servers`
