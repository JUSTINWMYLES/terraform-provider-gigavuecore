...
* `negative_heartbeat_profiles` (Attributes List, computed) (see [below for nested schema](#nestedatt--negative_heartbeat_profiles))
...
<a id="nestedatt--negative_heartbeat_profiles"></a>
### Nested Schema for `negative_heartbeat_profiles`
