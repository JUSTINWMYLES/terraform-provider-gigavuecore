...
* `giga_topology_fabric_paths_details` (Attributes List, computed) (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details))
...
<a id="nestedatt--giga_topology_fabric_paths_details"></a>
### Nested Schema for `giga_topology_fabric_paths_details`
...
* `dst_vertices` (Attributes List) (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details--dst_vertices))
...
* `src_vertices` (Attributes List) (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details--src_vertices))
* `topology_links` (Attributes List) (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details--topology_links))
* `version` (Number) - Incremental version field to indicate the fabric path format
<a id="nestedatt--giga_topology_fabric_paths_details--dst_vertices"></a>
### Nested Schema for `giga_topology_fabric_paths_details.dst_vertices`
...
* `hash_tool_port` (Attributes List) - Hash bucket id to tool port mapping (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details--dst_vertices--hash_tool_port))
* `hash_type` (String)
...
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details--dst_vertices--health_state_reasons))
...
<a id="nestedatt--giga_topology_fabric_paths_details--dst_vertices--hash_tool_port"></a>
### Nested Schema for `giga_topology_fabric_paths_details.dst_vertices.hash_tool_port`

Read-Only:

* `hash_bucket_ids` (List of Number) - hash bucket id or range
* `tool_ports` (List of String) - tool port(s) mapped to hashBucketIds
<a id="nestedatt--giga_topology_fabric_paths_details--dst_vertices--health_state_reasons"></a>
### Nested Schema for `giga_topology_fabric_paths_details.dst_vertices.health_state_reasons`
...
<a id="nestedatt--giga_topology_fabric_paths_details--src_vertices"></a>
### Nested Schema for `giga_topology_fabric_paths_details.src_vertices`
...
* `failover_status` (String) - Failover Status
* `hash_size` (Number) - Hash bucket size
* `hash_tool_port` (Attributes List) - Hash bucket id to tool port mapping (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details--src_vertices--hash_tool_port))
* `hash_type` (String)
* `hash_weights` (List of Number) - hashWeights for 'ports'.If included, the list size must match the size of the 'ports' list
* `health_state` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details--src_vertices--health_state_reasons))
* `ports` (List of String) - list of the ports to combine into a gigastream
* `threshold_level` (String) - Threshold level
* `variance_threshold` (String) - Variance threshold percentage
<a id="nestedatt--giga_topology_fabric_paths_details--src_vertices--hash_tool_port"></a>
### Nested Schema for `giga_topology_fabric_paths_details.src_vertices.hash_tool_port`

Read-Only:

* `hash_bucket_ids` (List of Number) - hash bucket id or range
* `tool_ports` (List of String) - tool port(s) mapped to hashBucketIds
<a id="nestedatt--giga_topology_fabric_paths_details--src_vertices--health_state_reasons"></a>
### Nested Schema for `giga_topology_fabric_paths_details.src_vertices.health_state_reasons`
...
* `severity` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `traffic_health_state_computation_type` (String) - Traffic Health State Computation Type
<a id="nestedatt--giga_topology_fabric_paths_details--topology_links"></a>
### Nested Schema for `giga_topology_fabric_paths_details.topology_links`
...
* `endpoint1` (Attributes) - node link endpoint (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details--topology_links--endpoint1))
* `endpoint2` (Attributes) - node link endpoint (see [below for nested schema](#nestedatt--giga_topology_fabric_paths_details--topology_links--endpoint2))
...
<a id="nestedatt--giga_topology_fabric_paths_details--topology_links--endpoint1"></a>
### Nested Schema for `giga_topology_fabric_paths_details.topology_links.endpoint1`
...
<a id="nestedatt--giga_topology_fabric_paths_details--topology_links--endpoint2"></a>
### Nested Schema for `giga_topology_fabric_paths_details.topology_links.endpoint2`
