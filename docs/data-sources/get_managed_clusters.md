...
* `clusters` (Attributes List, computed) (see [below for nested schema](#nestedatt--clusters))
...
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--clusters--health_state_reasons))
* `leader_id` (String) - id of stack's leader device
* `master_id` (String) - id of stack's master device. (deprecated: use leaderId)
* `members` (Attributes List) (see [below for nested schema](#nestedatt--clusters--members))
<a id="nestedatt--clusters--health_state_reasons"></a>
### Nested Schema for `clusters.health_state_reasons`
...
* `family` (String)
* `health_state` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--clusters--members--health_state_reasons))
...
<a id="nestedatt--clusters--members--health_state_reasons"></a>
### Nested Schema for `clusters.members.health_state_reasons`
