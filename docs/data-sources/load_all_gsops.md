...
* `apf` (Attributes) - Only applicable for H-series (see [below for nested schema](#nestedatt--items--gs_apps--apf))
* `dedup` (Attributes) (see [below for nested schema](#nestedatt--items--gs_apps--dedup))
* `diameter_whitelist` (Attributes) - Only applicable for H-series (see [below for nested schema](#nestedatt--items--gs_apps--diameter_whitelist))
...
* `gseries_header_remove` (Attributes) - Only applicable for G-series (see [below for nested schema](#nestedatt--items--gs_apps--gseries_header_remove))
...
* `gtp_whitelist` (Attributes) - Only applicable for H-series (see [below for nested schema](#nestedatt--items--gs_apps--gtp_whitelist))
...
* `metadata_export` (Attributes) - Only applicable for H-series (see [below for nested schema](#nestedatt--items--gs_apps--metadata_export))
* `netflow` (Attributes) - Only applicable for H-series (see [below for nested schema](#nestedatt--items--gs_apps--netflow))
* `sa_apf` (Attributes) - Deprecated (functionality will not be supported from 5.4 release onwards); Only applicable for H-series (see [below for nested schema](#nestedatt--items--gs_apps--sa_apf))
* `sip_whitelist` (Attributes) - Only applicable for H-series (see [below for nested schema](#nestedatt--items--gs_apps--sip_whitelist))
...
* `custom` (Attributes) - only applicable for 'custom', in which case it is required. (see [below for nested schema](#nestedatt--items--gs_apps--tunnel_decap--custom))
...
* `tls_pcapng` (Attributes) - only applicable for 'tls-pcapng', in which case it is required (see [below for nested schema](#nestedatt--items--gs_apps--tunnel_decap--tls_pcapng))
* `type` (String)
* `vxlan` (Attributes) - only applicable for 'vxlan', in which case it is required. (see [below for nested schema](#nestedatt--items--gs_apps--tunnel_decap--vxlan))
...
* `tls_pcapng` (Attributes) - only applicable for 'tls-pcapng', in which case it is required (see [below for nested schema](#nestedatt--items--gs_apps--tunnel_encap--tls_pcapng))
* `type` (String)
