...
* `inline_serial_tool_groups` (List(Object({alias, comment, enabled, failover_action, health_state, health_state_reasons, inline_tools, per_direction_order})), computed)
