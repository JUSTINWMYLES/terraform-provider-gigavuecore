---
page_title: "gigavuecore_get_flex_inline_config Data Source - gigavuecore"
subcategory: ""
description: |-
  Gets all flexInline configs present for the given solution
---

# gigavuecore_get_flex_inline_config Data Source
...
* `alias` (String, required) - Solution alias for which all config details is needed
