...
* `nf_exporters` (List(Object({alias, cluster_id, description, destination, dscp, filter, format, nf_version, snmp, template_refresh, transport, ttl, tunneled_port})), computed)
