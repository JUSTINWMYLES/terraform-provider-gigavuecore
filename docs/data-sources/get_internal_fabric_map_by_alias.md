---
page_title: "gigavuecore_get_internal_fabric_map_by_alias Data Source - gigavuecore"
subcategory: ""
description: |-
  Get an internally fabric map by alias
---

# gigavuecore_get_internal_fabric_map_by_alias Data Source
...
```terraform
data "gigavuecore_get_internal_fabric_map_by_alias" "example" {
  alias     = "example"
  ifm_alias = "example"
}
```
...
* `afm_map` (Attributes, computed) - Detailed definition of this fabric map (see [below for nested schema](#nestedatt--afm_map))
