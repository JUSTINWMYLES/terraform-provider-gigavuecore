...
* `chassis_id` (String)
* `cpld_version` (String)
* `cpu_load_avg` (Attributes) - CPU Load Average (see [below for nested schema](#nestedatt--items--cpu_load_avg))
* `device_name` (String) - maps to hostname
* `fan_trays` (Attributes List) (see [below for nested schema](#nestedatt--items--fan_trays))
* `file_system_statistics` (Attributes) - File System Statistics (see [below for nested schema](#nestedatt--items--file_system_statistics))
* `gdp` (Boolean) - enable/disable GDP for chassis
* `git_full_hash` (String)
* `global_node_id` (String)
* `hardware_info` (Attributes) - hardware info  of dell box (see [below for nested schema](#nestedatt--items--hardware_info))
...
* `leaf_config` (Attributes) - Configuration of Leaf node for Spine-Link (see [below for nested schema](#nestedatt--items--leaf_config))
* `memory` (Attributes) - Device Memory (see [below for nested schema](#nestedatt--items--memory))
...
* `oper_status` (String)
* `ports` (Attributes List) - details of the ports on this chassis (see [below for nested schema](#nestedatt--items--ports))
* `power_management` (Attributes) - Power Manager Information (see [below for nested schema](#nestedatt--items--power_management))
* `power_modules` (Attributes List) (see [below for nested schema](#nestedatt--items--power_modules))
...
* `health_state` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--items--cards--health_state_reasons))
* `hw_revision` (String)
* `hw_type` (String)
* `mode` (String)
* `oper_status` (String)
* `pld_info` (Attributes) - only applicable to HC3 chassis (see [below for nested schema](#nestedatt--items--cards--pld_info))
* `power_priority` (Number) - Power slot Priority
* `power_req` (Number) - watt
* `product_code` (String)
* `serial_number` (String)
* `slot_id` (String) - device card slot id
* `temperatures` (Attributes) (see [below for nested schema](#nestedatt--items--cards--temperatures))
* `voltages` (Attributes List) (see [below for nested schema](#nestedatt--items--cards--voltages))

<a id="nestedatt--items--cards--health_state_reasons"></a>
### Nested Schema for `items.cards.health_state_reasons`
...
<a id="nestedatt--items--cards--pld_info"></a>
### Nested Schema for `items.cards.pld_info`
...
<a id="nestedatt--items--cards--temperatures"></a>
### Nested Schema for `items.cards.temperatures`
...
<a id="nestedatt--items--cards--voltages"></a>
### Nested Schema for `items.cards.voltages`
...
<a id="nestedatt--items--cpu_load_avg"></a>
### Nested Schema for `items.cpu_load_avg`
...
<a id="nestedatt--items--fan_trays"></a>
### Nested Schema for `items.fan_trays`

Read-Only:

* `fan_details` (Attributes List) (see [below for nested schema](#nestedatt--items--fan_trays--fan_details))
* `fantray_id` (String) - chassis Fan Tray id
* `health_state` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--items--fan_trays--health_state_reasons))
* `hw_revision` (String)
* `hw_type` (String)
* `oper_status` (String)
* `product_code` (String)
...
<a id="nestedatt--items--fan_trays--fan_details"></a>
### Nested Schema for `items.fan_trays.fan_details`
...
<a id="nestedatt--items--fan_trays--health_state_reasons"></a>
### Nested Schema for `items.fan_trays.health_state_reasons`
...
<a id="nestedatt--items--file_system_statistics"></a>
### Nested Schema for `items.file_system_statistics`

Read-Only:

* `config_statistics` (Attributes) - File System Statistics (see [below for nested schema](#nestedatt--items--file_system_statistics--config_statistics))
* `time_stamp` (String) - date-time of stats collection in RFC 3339 format
* `var_statistics` (Attributes) - File System Statistics (see [below for nested schema](#nestedatt--items--file_system_statistics--var_statistics))

<a id="nestedatt--items--file_system_statistics--config_statistics"></a>
### Nested Schema for `items.file_system_statistics.config_statistics`
...
<a id="nestedatt--items--file_system_statistics--var_statistics"></a>
### Nested Schema for `items.file_system_statistics.var_statistics`
...
<a id="nestedatt--items--hardware_info"></a>
### Nested Schema for `items.hardware_info`
...
<a id="nestedatt--items--leaf_config"></a>
### Nested Schema for `items.leaf_config`

Read-Only:

* `mode` (String)

<a id="nestedatt--items--memory"></a>
### Nested Schema for `items.memory`
...
* `gsparams` (Attributes) - Gsparams Resource HW limit for engine port (see [below for nested schema](#nestedatt--items--ports--gsparams))
* `health_state` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--items--ports--health_state_reasons))
...
* `sfp` (Attributes) - Port SFP details (see [below for nested schema](#nestedatt--items--ports--sfp))
* `ude` (Attributes) - Unidirectional Ethernet (see [below for nested schema](#nestedatt--items--ports--ude))

<a id="nestedatt--items--ports--gsparams"></a>
### Nested Schema for `items.ports.gsparams`

Read-Only:

* `bufferasf` (Attributes) (see [below for nested schema](#nestedatt--items--ports--gsparams--bufferasf))
* `metadata` (Attributes) (see [below for nested schema](#nestedatt--items--ports--gsparams--metadata))

<a id="nestedatt--items--ports--gsparams--bufferasf"></a>
### Nested Schema for `items.ports.gsparams.bufferasf`
...
<a id="nestedatt--items--ports--gsparams--metadata"></a>
### Nested Schema for `items.ports.gsparams.metadata`
...
<a id="nestedatt--items--ports--health_state_reasons"></a>
### Nested Schema for `items.ports.health_state_reasons`
...
<a id="nestedatt--items--ports--sfp"></a>
### Nested Schema for `items.ports.sfp`
...
<a id="nestedatt--items--ports--ude"></a>
### Nested Schema for `items.ports.ude`

Read-Only:

* `enabled` (Boolean) - Only applicable if 100g-bidi is detected

<a id="nestedatt--items--power_management"></a>
### Nested Schema for `items.power_management`
...
<a id="nestedatt--items--power_modules"></a>
### Nested Schema for `items.power_modules`

Read-Only:

* `capacity` (Number) - watts
* `health_state` (String) - Read-only. 'green' indicates healthy state; 'yellow'  indicates warning state; 'orange'  indicates error state; 'red'  indicates critical state;
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--items--power_modules--health_state_reasons))
* `hw_revision` (String)
* `hw_type` (String)
...
* `power_voltages` (Attributes List) (see [below for nested schema](#nestedatt--items--power_modules--power_voltages))
* `product_code` (String)
* `serial_number` (String)

<a id="nestedatt--items--power_modules--health_state_reasons"></a>
### Nested Schema for `items.power_modules.health_state_reasons`
...
<a id="nestedatt--items--power_modules--power_voltages"></a>
### Nested Schema for `items.power_modules.power_voltages`
