...
* `entries` (Attributes List, computed) (see [below for nested schema](#nestedatt--entries))
...
* `file_meta_data` (Attributes) (see [below for nested schema](#nestedatt--entries--file_meta_data))
...
<a id="nestedatt--entries--file_meta_data"></a>
### Nested Schema for `entries.file_meta_data`
...
* `member_info` (Attributes List) (see [below for nested schema](#nestedatt--entries--file_meta_data--member_info))

<a id="nestedatt--entries--file_meta_data--member_info"></a>
### Nested Schema for `entries.file_meta_data.member_info`
