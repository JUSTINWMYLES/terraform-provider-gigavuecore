...
* `inline_networks` (Attributes List, computed) (see [below for nested schema](#nestedatt--inline_networks))
...
<a id="nestedatt--inline_networks"></a>
### Nested Schema for `inline_networks`
...
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--inline_networks--health_state_reasons))
* `heartbeat` (Attributes) - Embedded Heartbeat configuration for an Inline Network. (see [below for nested schema](#nestedatt--inline_networks--heartbeat))
...
* `traffic_path` (String)
* `type` (String)
<a id="nestedatt--inline_networks--health_state_reasons"></a>
### Nested Schema for `inline_networks.health_state_reasons`
...
<a id="nestedatt--inline_networks--heartbeat"></a>
### Nested Schema for `inline_networks.heartbeat`
