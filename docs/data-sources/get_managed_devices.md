...
* `nodes` (Attributes List, computed) (see [below for nested schema](#nestedatt--nodes))
...
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--nodes--health_state_reasons))
...
<a id="nestedatt--nodes--health_state_reasons"></a>
### Nested Schema for `nodes.health_state_reasons`
