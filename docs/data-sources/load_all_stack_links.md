...
* `stack_links` (Attributes List, computed) (see [below for nested schema](#nestedatt--stack_links))
...
<a id="nestedatt--stack_links"></a>
### Nested Schema for `stack_links`
...
* `health_state_reasons` (Attributes List) (see [below for nested schema](#nestedatt--stack_links--health_state_reasons))
...
<a id="nestedatt--stack_links--health_state_reasons"></a>
### Nested Schema for `stack_links.health_state_reasons`
