...
* `clusters_config_backups` (Attributes List, computed) (see [below for nested schema](#nestedatt--clusters_config_backups))
* `context` (Attributes, computed) - Gigamon query result context (see [below for nested schema](#nestedatt--context))

<a id="nestedatt--clusters_config_backups"></a>
### Nested Schema for `clusters_config_backups`

Read-Only:

* `cluster_id` (String) - Id of the cluster
* `cluster_name` (String) - Name of the cluster
* `entries` (Attributes List) (see [below for nested schema](#nestedatt--clusters_config_backups--entries))
<a id="nestedatt--clusters_config_backups--entries"></a>
### Nested Schema for `clusters_config_backups.entries`
...
* `file_meta_data` (Attributes) (see [below for nested schema](#nestedatt--clusters_config_backups--entries--file_meta_data))
...
<a id="nestedatt--clusters_config_backups--entries--file_meta_data"></a>
### Nested Schema for `clusters_config_backups.entries.file_meta_data`
...
* `member_info` (Attributes List) (see [below for nested schema](#nestedatt--clusters_config_backups--entries--file_meta_data--member_info))
<a id="nestedatt--clusters_config_backups--entries--file_meta_data--member_info"></a>
### Nested Schema for `clusters_config_backups.entries.file_meta_data.member_info`
