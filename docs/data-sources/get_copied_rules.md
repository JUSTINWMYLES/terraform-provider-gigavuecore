...
* `application_rules` (Attributes) - Application rules (for APPLICATION category) (see [below for nested schema](#nestedatt--copied_rules--rule_set--application_rules))
...
* `source_rules` (Attributes) - Source rules (for SOURCE category) (see [below for nested schema](#nestedatt--copied_rules--rule_set--source_rules))
...
* `vlan_tag` (Attributes) - This field is only valid for 'regular/byRule', 'collector' map types (see [below for nested schema](#nestedatt--copied_rules--rule_set--source_rules--vlan_tag))
...
* `rule_id` (Number)
* `vlan_tag` (Attributes) - This field is only  applicable for pass rules (see [below for nested schema](#nestedatt--copied_rules--rule_set--source_rules--rules--drop_rules--vlan_tag))
...
* `rule_id` (Number)
* `vlan_tag` (Attributes) - This field is only  applicable for pass rules (see [below for nested schema](#nestedatt--copied_rules--rule_set--source_rules--rules--pass_rules--vlan_tag))
