---
page_title: "gigavuecore_get_cluster_circuit_tunnel_of_an_user_fabric_map Data Source - gigavuecore"
subcategory: ""
description: |-
  Get a cluster circuit tunnel endpoint of a user-defined fabric map
---

# gigavuecore_get_cluster_circuit_tunnel_of_an_user_fabric_map Data Source
...
```terraform
data "gigavuecore_get_cluster_circuit_tunnel_of_an_user_fabric_map" "example" {
  alias     = "example"
  cct_alias = "example"
}
```
...
* `circuit_tunnel` (Attributes, computed) - Detailed definition of this circuit tunnel endpoint (see [below for nested schema](#nestedatt--circuit_tunnel))
